...
| attributes.bundled_product | Boolean | Defines if the concrete product is a product bundle. 
...
| attributeNames.bundled_product | String | Defines if the concrete product is a product bundle. |
...
*     [Retrieving bundled products](https://documentation.spryker.com/upcoming-release/docs/retrieving-product-ratings-and-reviews#bundled-products-response-attributes)
