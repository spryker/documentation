This document describes the `product_concrete_pre_configuration.csv` file to configure [configurable product](https://documentation.spryker.com/upcoming-release/docs/configurable-product-feature-overview) information in your Spryker shop.
