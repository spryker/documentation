...
```bash
composer require spryker-feature/customer-account-management: "202009.0" spryker/oauth-customer-connector:"^1.6.0" --update-with-dependencies
```
...
```bash
composer require spryker-feature/customer-account-management: "202009.0" --update-with-dependencies
```
:::(Warning) (Verification)
