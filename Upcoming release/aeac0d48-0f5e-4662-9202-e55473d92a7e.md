...
For the attributes of the included resources, see [Items in Carts of Registered Users](https://documentation.spryker.com/docs/en/items-in-carts-of-registered-users).
...
For the registered cart attributes, see Retrieving all carts.
...
For the attributes of the included resources, see [Retrieving All Carts](https://documentation.spryker.com/docs/en/carts-of-registered-users#retrieing-carts).
...
For the attributes of the included resources, see [Gift Cards of Registered Users](https://documentation.spryker.com/docs/en/gift-cards-of-registered-users).
