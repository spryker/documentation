...
For the attributes of the included resources, see [Cart Permission Groups](https://spryker.atlassian.net/wiki/spaces/DOCS/pages/1645707497/Items+in+Carts+of+Registered+Users).
...
For the registered cart attributes, see [Retrieving all carts](http://#retrieving-all-carts).
...
For the attributes of the included resources, see [Viewing discounts applied to a purchase](https://documentation.spryker.com/docs/retrieving-discounts#viewing-discounts-applied-to-a-purchase)e.
