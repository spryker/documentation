...
| --- | --- |
| cart_uuid | A unique identifier of a cart. You can get this in the response when [creating carts](https://documentation.spryker.com/v6/docs/en/managing-carts-of-registered-users#creating-carts) or [retrieving all carts](https://documentation.spryker.com/v6/docs/en/managing-carts-of-registered-users#retrieving-all-carts). |
