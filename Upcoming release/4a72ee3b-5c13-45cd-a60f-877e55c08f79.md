...
*   [Retrieving concrete products](https://documentation.spryker.com/docs/en/retrieving-concrete-products#concrete-products-response-attributes)
    
*   [Retrieving abstract products](https://documentation.spryker.com/docs/en/retrieving-abstract-products#abstract-products-response-attributes)
...
*   [Retrieve bundled products of a concrete product](https://spryker.atlassian.net/wiki/spaces/DOCS/pages/1778286617/WIP+Retrieving+concrete+products#Retrieve-a-concrete-product)
    
*   [Retrieve bundled products of an abstract product](https://spryker.atlassian.net/wiki/spaces/DOCS/pages/1783922713/WIP+Retrieving+abstract+products#Retrieve-an-abstract-product)
    
*   [Manage bundled products in carts of registered users](https://spryker.atlassian.net/wiki/spaces/DOCS/pages/1790869531/WIP+Managing+items+in+carts+of+registered+users)
    
*   [Manage bundled products in guest carts](https://spryker.atlassian.net/wiki/spaces/DOCS/pages/1816461493/WIP+Managing+guest+cart+items)
