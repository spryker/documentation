...
| --- | --- | --- |
| Spryker Core | 202009.0 | [Glue Application](https://documentation.spryker.com/v3/docs/glue-application-feature-integration-201907) |
| Cart | 202009.0 | [Cart API](https://documentation.spryker.com/v3/docs/cart-feature-integration) |
| Customer Account Management | 202009.0 | |
| Payments | 202009.0 | [Payments API](https://documentation.spryker.com/v3/docs/payments-api-feature-integration-201907) |
