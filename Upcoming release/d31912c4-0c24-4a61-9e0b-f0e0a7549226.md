...
For the attributes of the included resources, see [Guest Cart Items](https://documentation.spryker.com/docs/en/guest-cart-items).
...
For the attributes of the included resources, see [Adding Items to Guest Carts](https://documentation.spryker.com/docs/en/guest-cart-items#adding-items-to-guest-carts).
