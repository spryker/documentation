...
| q | Restricts the returned items to the values of the provided parameters | <ul><li>{{null}} (empty)</li><li>{{abstract_product_sku}}</li><li>{{abstract_product_name}}</li><li>{{concrete_product_sku}}</li><li>{{product_attribute}} (for example, brand, color, etc.) - to provide multiple product attributes, use `+`</li></ul>|
| price[min] | Restricts the returned items to products with prices matching or above the provided value | {{minimum_price}} |
| price[max] | Restricts the returned items to products with prices matching or below the provided value | {{maximum_price}} |
...
| category | Specifies the category to search the products in | {{category_node_id}}</br>For the category node IDs, [retrieve the category tree](https://documentation.spryker.com/docs/retrieving-category-trees). |
...
| `GET https://glue.mysprykershop.com/catalog-search?q=Sony&sort=popularity` | Sort found products by popularity. **This is valid for Master Suite only and has not been integrated into B2B/B2C Suites yet.**   |
...
**Notice: Sort by popularity - This is valid for Master Suite only and has not been integrated into B2B/B2C Suites yet.**
...
<details open>
<summary>Response sample: Sorting by popularity (This is valid for Master Suite only and has not been integrated into B2B/B2C Suites yet.)</summary>
