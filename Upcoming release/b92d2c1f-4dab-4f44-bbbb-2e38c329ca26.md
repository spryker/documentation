...
1. Add a Gift Card to a guest shopping cart. See [Adding Items to Carts of Registered users](https://documentation.spryker.com/docs/en/guest-cart-items#adding-items-to-guest-carts) for more details.
