...
* [Glue API: Products Feature Integration]()

* [Glue API: Prices feature integration]() <!--add a link to this IG when published -->
...
|-|-|
|*** {{concreteproductsku}}*** | SKU of a concrete product to get the price of. |
