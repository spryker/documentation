This document describes how to integrate the [Customer Account Management](https://documentation.spryker.com/docs/customer-account-feature-overview) feature into a Spryker project. 
