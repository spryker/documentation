...
|attributes.bundled_product | Boolean | Defines if the abstract product is a product bundle. 
...
| attributeNames.bundled_product | String | Defines if the abstract product is a product bundle. |
