...
To start working with groups, go  to **Users Control** > **Groups**.
***
## Creating a Group
...
3. In the **Assigned Roles** drop-down menu, select the role to assign to this group and click **Save**.
    @(Warning)(Note)(You can select from one to many roles to be assigned.)
...
@(Info)()(This action will not delete the user itself. It will just delete the association between this specific user and group.)
