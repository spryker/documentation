...
The modules combine to create [features](https://documentation.spryker.com/docs/en/features) and have limited dependencies. The limited dependencies imply less development effort, increasing your return on investment and lowering the total cost of ownership.
...
* [About Spryker](https://documentation.spryker.com/docs/en/demoshops): general information about Spryker, news, and release notes.
* [Spryker Installation Guides](https://documentation.spryker.com/docs/en/about-installation): installation of Spryker.
* [Features](https://documentation.spryker.com/docs/en/features): the Spryker features.
