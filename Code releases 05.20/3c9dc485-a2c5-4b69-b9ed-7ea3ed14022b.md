...
To learn how to create and manage the Punch Out connections, see [Managing Punch Out connections](https://documentation.spryker.com/docs/en/en/managing-punchout-connections).
To learn how to manage the Punch Out translation logs, see  [Managing transaction logs](https://documentation.spryker.com/docs/en/en/managing-transactions-log).