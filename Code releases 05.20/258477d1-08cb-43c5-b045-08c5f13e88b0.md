...
To start working with merchants, go to **Merchants > Merchants**.
***
## Creating a Merchant 
...
See [Managing Merchant Relations](https://documentation.spryker.com/v4/docs/managing-merchant-relations) to know how you create those.