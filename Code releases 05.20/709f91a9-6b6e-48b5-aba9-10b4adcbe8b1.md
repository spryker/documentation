@(Error)(Attention!)(The following Feature Integration Guide expects the basic feature to be in place. The current Feature Integration Guide only adds the **Volume Prices** functionality and `PriceProductWidget`.)
...
@(Info)(Note)(The following imported entities will be used as product volumes in Spryker OS.)
...
| `PriceProductWidget` | Could be checked on a slot configurator page of a [Configurable Bundle](https://documentation.spryker.com/docs/en/en/configurable-bundle) feature. |
:::