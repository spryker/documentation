...
## Migration Guide
If you’re migrating the Tax module from version 2 to version 3, you need to follow the steps described in the [Migration Guide - Tax](https://documentation.spryker.com/docs/en/en/mg-tax).