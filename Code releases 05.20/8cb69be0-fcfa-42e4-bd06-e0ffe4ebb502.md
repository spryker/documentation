B2C API React Example can be installed inside [Spryker Development Virtual Machine](https://documentation.spryker.com/docs/en/devvm) (VM) or on a separate dedicated server. Below, you will find detailed steps on how to perform both the installation scenarios.
...
1. Make sure that you have Spryker Glue REST API [installed and working](https://documentation.spryker.com/docs/en/glue-api-installation-and-configuration).
