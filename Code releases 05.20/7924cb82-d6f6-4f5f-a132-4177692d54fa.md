...
| payments | RestPayment | x | Payment options, such as the payment system, method of payment, etc.</br>For details, see [Payment Step](https://documentation.spryker.com/v5/docs/payment-step-shop-guide-201911){target="_blank"}. |
...
| payments | RestPayment | v | Payment options, such as the payment system, method of payment, etc.</br>For details, see [Payment Step](https://documentation.spryker.com/v5/docs/payment-step-shop-guide-201911){target="_blank"}. |
| shipment | RestShipmentTransfer | v | Shipment details.</br>For details, see [Shipment Step](https://documentation.spryker.com/v5/docs/shipment-step-shop-guide-201911){target="_blank"}. |
