...
`FULL_MERGE_STRATEGY` is a strategy by which root navigation elements are being merged with core navigation elements. This strategy for merging of all navigation elements from core and project level.
