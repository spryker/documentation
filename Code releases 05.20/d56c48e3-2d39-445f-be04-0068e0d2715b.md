...
To start managing product labels, go to **Products** > **Product Labels**.
...
2. On the **Edit Product Label** page, edit the values. See [Product Labels: Reference Information](https://documentation.spryker.com/v4/docs/product-labels-reference-information).
...
***
**What's next?** 
* Learn how to prioritize a label in the [Prioritizing Labels](https://documentation.spryker.com/v4/docs/prioritizing-labels) topic.
* To learn what attributes you enter and select while editing the product label, see the [Product Labels: Reference Information](https://documentation.spryker.com/v4/docs/product-labels-reference-information) article.