...
namespace Pyz\Yves\Price\Plugin\Router;
...
class PriceRouteProviderPlugin extends AbstractRouteProviderPlugin
{
    ...
    {
        $route = $this->buildRoute('/price-mode-switc', 'Price', 'PriceModeSwitch', 'index');
...
3. Register in Yves `RouterDependencyProvider`:
```php
<?php
...
class RouterDependencyProvider extends SprykerRouterDependencyProvider
{
    ...
    protected function getRouteProvider(): array
    {
        return [
            // ...
            new PriceRouteProviderPlugin($isSsl),
            // ...
        ]
    }
}
