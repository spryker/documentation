:::(Error) 
This migration guide is a part of the [Silex migration effort](https://documentation.spryker.com/docs/en/en/silex-replacement).
:::
...
:::(Info) ()
For information on how to eliminate Silex Validator, see  [Migration Guide - Validator](https://documentation.spryker.com/docs/en/en/migration-guide-validator).
:::
