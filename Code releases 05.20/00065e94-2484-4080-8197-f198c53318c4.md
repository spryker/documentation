    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v5/docs/en/minimum-order-value-feature-overview-201903" class="mr-link">Get a general idea of the Minimum Order Value feature</a></li>
                ...
                <li><a href="https://documentation.spryker.com/v5/docs/en/minimum-order-value-feature-integration-201903" class="mr-link">Integrate the Minimum Order Value feature v. 201903.0 into your project</a></li>
            </ul>
        </div>
        <!-- col2 -->
        <div class="mr-col">
