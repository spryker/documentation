...
To start managing users, go to **Content Management** > **Users**.
...
2. Enter and select the following attributes.  
    ...
    * Agent
    * Interface language.
    @(Info)()(See [User: Reference Information](https://documentation.spryker.com/v4/docs/user-reference-information) to know more about these attributes.)
3. Click **Create**.
...
## Editing a User
**To edit a user:**
1. In **Users List > Action** column, click **Edit**  if you want to change user's details. See [User: Reference Information](https://documentation.spryker.com/v4/docs/user-reference-information) for  more details.
