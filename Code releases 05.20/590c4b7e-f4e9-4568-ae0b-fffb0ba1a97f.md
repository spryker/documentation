...
| Return item attributes | Return item statuses | Statuses of your return. They can be:<ul><li>Waiting for return</li><li>Returned Refunded</li><li>Canceled</li><li>Shipped to customer</li><li>Delivered</li><li>Closed</li> |
