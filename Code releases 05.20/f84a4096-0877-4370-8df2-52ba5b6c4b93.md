...
@(Warning)(Authentication Required)(To get a list of Company Users, you need to authenticate first and pass an access token as a part of your request. For details, see [Authentication and Authorization](https://documentation.spryker.com/docs/en/authentication-and-authorization).)
...
@(Warning)(Note)(The company user identifier contained in the id member can be used to access the Company User in the future as well as impersonate as that account. For details, see [Logging In as Company User](https://documentation.spryker.com/docs/en/logging-in-as-company-user-201907).)
...
@(Warning)(Authentication Required)(To get information on a Company User, you need to authenticate first and pass an access token as a part of your request. For details, see [Authentication and Authorization](https://documentation.spryker.com/docs/en/authentication-and-authorization).)
