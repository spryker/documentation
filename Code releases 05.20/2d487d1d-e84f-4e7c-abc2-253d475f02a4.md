...
* [Credit Card](https://documentation.spryker.com/docs/en/en/computop-credit-card)
* [Direct Debit](https://documentation.spryker.com/docs/en/en/computop-direct-debit)
* [EasyCredit](https://documentation.spryker.com/docs/en/en/computop-easy-credit)
* [iDeal](https://documentation.spryker.com/docs/en/en/computop-ideal)
* [Paydirekt](https://documentation.spryker.com/docs/en/en/computop-paydirekt)
* [PayNow](https://documentation.spryker.com/docs/en/en/computop-paynow)
* [PayPal](https://documentation.spryker.com/docs/en/en/computop-paypal)
* [SofortÜberweisung](https://documentation.spryker.com/docs/en/en/computop-sofort)
