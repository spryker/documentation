...
Also, Code Releases are not incorporated into the [Demo Shops](https://documentation.spryker.com/docs/en/demoshops) and can contain beta versions on modules.
