...
@(Info)()(For detailed information on global styles, see the _SASS Layer_ section in [Atomic Frontend](https://documentation.spryker.com/docs/en/en/atomic-frontend#sass-layer).)
