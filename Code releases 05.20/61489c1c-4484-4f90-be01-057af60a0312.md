...
2.     In the *Create child node* section:
    1. Select the node **Type**. See [Navigation: Reference Information](https://documentation.spryker.com/docs/navigation-node-types) to learn about the node types.
    2. Fill out the required fields per each locale.
...
To learn how to configure Navigation, check the video:
...
1.     In the *List of navigation elements*, select the navigation element owing the navigation node you want to delete.
...
To know more about navigation node types, see [Navigation Node Types](https://documentation.spryker.com/docs/navigation-node-types).