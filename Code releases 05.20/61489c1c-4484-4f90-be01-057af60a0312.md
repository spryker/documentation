This topic describes how to manage navigation elements.

To start managing navigation elements, navigate to the **Navigation** section.
***
...
## Editing, Deleting, Deactivating and Activating a Navigation Element
...
## Reordering Nodes
To reorder nodes:
1. Drag and drop elements in the tree. 
...
**Tips & Tricks**
To know more about the node types that you select, see [Navigation Node Types](https://documentation.spryker.com/v4/docs/navigation-node-types) in the References section.
