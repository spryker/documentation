...
Version 1.1.2 boosts the overall Zed and Glue performance by introducing a [cache of unresolved entities for Zed](https://documentation.spryker.com/docs/performance-guidelines#activate-zed-navigation-cache--default-on).
