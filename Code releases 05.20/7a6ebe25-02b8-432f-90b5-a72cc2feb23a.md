...
Version 2.0.0 of the ContentBannerGui module introduces the [Content Items](https://documentation.spryker.com/docs/en/en/content-items-overview-201907) functionality that allows creating and managing content and later selecting where it should be inserted.
...
1. Upgrade the `Content` Module to version 2.0.0. Follow the steps described in [Migration Guide - Content](https://documentation.spryker.com/docs/en/en/mg-content-201907).
2. Upgrade the `ContentBanner` to version 2.0.0. Follow the steps described in [Migration Guide - ContentBanner](https://documentation.spryker.com/docs/en/en/mg-contentbanner-201907).
