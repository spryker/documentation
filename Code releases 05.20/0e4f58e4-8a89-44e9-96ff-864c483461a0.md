...
See:
* [Configuring Elasticsearch](https://documentation.spryker.com/docs/en/en/search-configure-elasticsearch) to learn more about Elastcisearch configuration in Spryker.
