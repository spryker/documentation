...
@(Info)()(See [Managing Carts of Registered Users](https://documentation.spryker.com/docs/en/managing-carts-of-registered-users) to learn how you can manage carts of registered users via Glue API.)
