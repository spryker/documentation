...
@(Info)()(See [Managing Carts of Registered Users](https://documentation.spryker.com/docs/managing-carts-of-registered-users) to learn how you can manage carts of registered users via Glue API.)


## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see:
* [Carts API](https://documentation.spryker.com/docs/glue-api-cart-feature-integration)
...
```json
{
    ...
    "included": [
        ...
        },
        {
            ...
            "links": {
                "self": "https://glue.de.suite.local/promotional-items/bfc600e1-5bf1-50eb-a9f5-a37deb796f8a"
            },
            "relationships": {
                "abstract-products": {
                    "data": [
...
---
`DELETE` **/guest-carts/*{{guestCartId}}*/guest-cart-items/*{{concrete_product_sku}}***
...
| --- | --- |
| {{concrete_product_sku}} | SKU of a concrete product to add. |

:::(Info) (Guest cart ID)


Even though guest users have one cart by default, you can optionally specify its ID when deleting . To do that, use the following endpoint. The information in this section is valid for both of the endpoints.
...
---
`PATCH` **/guest-carts/*{{guestCartId}}*/guest-cart-items/*{{concrete_product_sku}}***
