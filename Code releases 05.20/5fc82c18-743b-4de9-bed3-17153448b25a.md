...
:::(Info) (Info)
For more details on how to create the discount conditions, see [Creating a Cart Rule Discount](https://documentation.spryker.com/v5/docs/creating-a-cart-rule).
:::
