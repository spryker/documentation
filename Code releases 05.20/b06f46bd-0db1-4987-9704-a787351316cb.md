...
A product catalog manager selects a discount type when [creating a voucher](https://documentation.spryker.com/docs/en/en/creating-a-voucher) or [creating a cart rule](https://documentation.spryker.com/docs/en/en/creating-a-cart-rule).
...
See [Creating a Voucher](https://documentation.spryker.com/docs/en/en/creating-a-voucher) to learn how a product catalog manager can create a voucher in the Back Office.
...
See [Creating a Cart Rule](https://documentation.spryker.com/docs/en/en/creating-a-cart-rule) to learn how a product catalog manager can create a cart rule in the Back Office.
...
@(Info)()(With the calculator fixed type, the currency of the respective shop is used for calculation.)
...
A product catalog manager defines calculation when [creating a voucher](https://documentation.spryker.com/docs/en/en/creating-a-voucher) or [creating a cart rule](https://documentation.spryker.com/docs/en/en/creating-a-cart-rule).
