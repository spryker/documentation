This article contains content of the **navigation.csv** file to configure [Navigation](https://documentation.spryker.com/docs/navigation) information on your Spryker Demo Shop.
...
| --- | --- | --- | --- | --- |
| **key** | Yes | String |N/A* | Navigation entity key. |
| **name** | Yes | String |N/A | Navigation entity name. |
*N/A: Not applicable.
