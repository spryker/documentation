...
***
You can create [multiple wishlists](https://documentation.spryker.com/v4/docs/multiple-wishlists) and save products to them for future purchases. This may be useful when, for example, you do not intend to purchase products at the moment but want to do this later once you return to the online store. Also, you can add to these lists the products you are interested in.
