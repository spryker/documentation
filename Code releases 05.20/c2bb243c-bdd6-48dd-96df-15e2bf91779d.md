...
***
You can create [multiple wishlists](https://documentation.spryker.com/docs/en/en/multiple-wishlists) and save products to them for future purchases. This may be useful when, for example, you do not intend to purchase products at the moment but want to do this later once you return to the online store. Also, you can add to these lists the products you are interested in.
...
If you have added the products to the cart, you can proceed to the checkout. For more information on how to place the order, see [Shop Guide - Checkout](https://documentation.spryker.com/docs/en/en/checkout-shop-guide-201911#shop-guide---checkout).