## Setup
The following configuration should be made after Heidelpay has been [installed](https://documentation.spryker.com/docs/en/en/heidelpay-installation) and [integrated](https://documentation.spryker.com/docs/en/en/heidelpay-integration-scos).
