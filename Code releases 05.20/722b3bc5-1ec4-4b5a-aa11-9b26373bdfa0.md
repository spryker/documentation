In corporate environments, where users act as company representatives rather than private buyers, companies can leverage [Company Roles](https://documentation.spryker.com/docs/en/en/company-roles-permissions-overview) in order to distribute scopes and permissions among [Company Users](https://documentation.spryker.com/docs/en/en/company-account-overview). To identify which roles company users are assigned to, you can use the endpoints provided by the **Company Role API**.
...
[/company-roles/mine](https://documentation.spryker.com/docs/en/en/rest-api-reference#//company-roles)
...
[/company-roles/{{role_id}}](https://documentation.spryker.com/docs/en/en/rest-api-reference#//company-roles){target="_blank"}
