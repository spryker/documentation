...
@(Info)()(For more details, check [Cart Data Flow](https://documentation.spryker.com/docs/en/cart-functionality#cart-data-flow) in the *Cart Functionality* section.)
...
@(Info)(Discount Calculation)(Discount calculation is a separate topic and is explained in the [Discount](https://documentation.spryker.com/docs/en/discount) article.)
