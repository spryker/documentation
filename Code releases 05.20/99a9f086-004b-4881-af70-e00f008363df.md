...
@(Info)()(For more details, see [Glue Infrastructure](https://documentation.spryker.com/docs/en/glue-infrastructure).)
...
@(Info)()(For more details, see [REST API Reference](https://documentation.spryker.com/docs/en/rest-api-reference).)
...
@(Info)()([Install and run!](https://documentation.spryker.com/docs/en/b2c-api-react-example))
