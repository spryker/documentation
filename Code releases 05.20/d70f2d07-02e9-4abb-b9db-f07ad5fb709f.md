...
**Documentation**: [Product is Available Again](https://documentation.spryker.com/docs/en/en/product-is-available-again-201903).
...
**Documentation**: [Discount](https://documentation.spryker.com/docs/en/en/discount). 
...
**Documentation**: [Back Office Translations](https://documentation.spryker.com/docs/en/en/back-office-translations-201903).
...
**Documentation**: [Category](https://documentation.spryker.com/docs/en/en/category-management-201903).
...
**Documentation**: [Multi-store CMS Pages](https://documentation.spryker.com/docs/en/en/multi-store-cms-pages-201903).
...
**Documentation**: [CMS Pages in Search Results](https://documentation.spryker.com/docs/en/en/cms-pages-in-search-results-201903).
...
**Documentation**: [Assigning a Template for a Category Page](https://documentation.spryker.com/docs/en/en/category)
...
**Documentation**: [CMS Block widget](https://documentation.spryker.com/docs/en/en/content-widgets)
...
**Documentation**: [Session Management](https://documentation.spryker.com/docs/en/en/session-handlers).
...
**Documentation**: [Code Sniffer](https://documentation.spryker.com/docs/en/en/code-sniffer), [Architecture Sniffer](https://documentation.spryker.com/docs/en/en/architecture-sniffer), [PHPStan](https://documentation.spryker.com/docs/en/en/phpstan-201903).
...
**Documentation**: [Spryk](https://documentation.spryker.com/docs/en/en/spryk-201903).
...
**Documentation**: [Retrieving Related Products](https://documentation.spryker.com/docs/en/en/retrieving-related-products-201903).

### Navigation
Every navigation node and its structure are retrievable via the navigation API endpoint.

**Documentation**: [Retrieving Navigation Trees](https://documentation.spryker.com/docs/en/en/retrieving-navigation-trees-201903).
...
**Documentation**: [Retrieving Alternative Products](https://documentation.spryker.com/docs/en/en/retrieving-alternative-products-201903).
...
**Documentation**: [Configuring Visibility of the Included Section](https://documentation.spryker.com/docs/en/en/ht-configuring-visibility-included-section-201903).
...
**Documentation**: [Quick Order](https://documentation.spryker.com/docs/en/en/quick-order-201903).
...
**Documentation**: [Approval Process](https://documentation.spryker.com/docs/en/en/approval-process-201903).
...
**Documentation**: [Checkout](https://documentation.spryker.com/docs/en/en/address-step-shop-guide-201911), [Business on Behalf](https://documentation.spryker.com/docs/en/en/business-on-behalf-201903), [Reclamations](https://documentation.spryker.com/docs/en/en/reclamations-201903).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](https://documentation.spryker.com/docs/en/en/heidelpay-split-payment-marketplace).
...
**Documentation**: [Adyen](https://documentation.spryker.com/docs/en/en/adyen).
...
**Documentation**: [AfterPay](https://documentation.spryker.com/docs/en/en/afterpay).
