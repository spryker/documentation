...
@(Info)(Info)(For details on how to receive the token, see [Logging In as Company User](https://documentation.spryker.com/docs/en/logging-in-as-company-user-201907){target="_blank"}.)
...
[/cart-permission-groups/{{permission_group_id}}](https://documentation.spryker.com/docs/en/rest-api-reference#/cart-permission-groups){target="_blank"}
...
@(Warning)(Authentication Required)(To get Cart Permission Groups, you need to authenticate first and pass an access token as a part of your request. For details, see [Authentication and Authorization](https://documentation.spryker.com/docs/en/authentication-and-authorization){target="_blank"}.)
...
[/carts/{{cartId}}](https://documentation.spryker.com/docs/en/rest-api-reference#/carts){target="_blank"} - provides information on a specific cart.
...
@(Warning)(Authentication)(To use this endpoint, customers need to authenticate first.  For details, see [Authentication and Authorization](https://documentation.spryker.com/docs/en/authentication-and-authorization){target="_blank"}.)
...
@(Info)(Info)(For a detailed list of **RestCartsResponse** attributes, see section *Retrieving Carts* in [Managing Carts of Registered Users](https://documentation.spryker.com/docs/en/managing-carts-of-registered-users-201907#retrieving-carts){target="_blank"}.)
...
[/carts/{{cart-uuid}}/shared-carts](https://documentation.spryker.com/docs/en/rest-api-reference#/carts){target="_blank"}
...
[/shared-carts/{{shared-cart-uuid}}](https://documentation.spryker.com/docs/en/rest-api-reference#/shared-carts){target="_blank"}
