...
@(Info)()(See [CMS Redirects: Reference Information](https://documentation.spryker.com/v4/docs/cms-redirects-references) to learn more information about the attributes you need to enter.)
...
***
**What's next?**
To learn more about attributes you enter on the page, see [CMS Redirects: Reference Information](https://documentation.spryker.com/v4/docs/cms-redirects-references).