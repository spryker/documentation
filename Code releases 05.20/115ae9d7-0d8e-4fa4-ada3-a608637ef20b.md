...
Version 2.0.0 of the ContentGui module introduces the [Content Items](https://documentation.spryker.com/docs/en/en/content-items-overview-201907) functionality that allows creating and managing content and later selecting where it should be inserted.
...
1. Perform the steps provided in [Migration Guide - ContentStorage](https://documentation.spryker.com/docs/en/en/mg-contentstorage-201907).
