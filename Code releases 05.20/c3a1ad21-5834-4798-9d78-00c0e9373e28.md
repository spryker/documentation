...
* [B2B Demo Shop](https://documentation.spryker.com/docs/demoshops#b2b-demo-shop)
* [B2C Demo Shop](https://documentation.spryker.com/docs/demoshops#b2c-demo-shop)
* [Master Suite](https://documentation.spryker.com/docs/demoshops#master-suite)
...
:::(Warning) (Warning)
Make sure you use the integration guide for the feature version you need. To select a specific version of the feature integration guide, choose the documentation (product release) version in the green dropdown on the right of the page. This will switch the version of the documentation to the selected one.
:::
