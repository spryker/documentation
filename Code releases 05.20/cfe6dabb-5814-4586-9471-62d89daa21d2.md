...
@(Info)()(For more details, see section _Twig_ in [Atomic Frontend](https://documentation.spryker.com/docs/en/atomic-frontend#twig).)
...
@(Info)()(See component implementation in [How To Create a Component](https://documentation.spryker.com/docs/en/t-create-component).)
...
@(Info)()(You can find the original Twig of the component in the _Create Component Template_ section of [HowTo - Create a Component](https://documentation.spryker.com/docs/en/t-create-component).)
