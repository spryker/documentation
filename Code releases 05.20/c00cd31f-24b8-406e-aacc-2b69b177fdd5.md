...
With the search widget, a customer can always find the items that are available specifically to them as [Product Restriction](https://documentation.spryker.com/docs/en/en/product-restrictions-from-merchant-to-buyer-201903) are considered while searching. This means, that if a blacklist rule exists for a customer, the products that are added to that rule will not be displayed in the search results.

@(Info)()(You can find more examples of product restriction use cases on the [Restricted Products Behavior](https://documentation.spryker.com/docs/en/en/restricted-products-behavior) page.)
