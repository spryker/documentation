...
@(Info)()(You can find more examples of product restriction use cases on the [Restricted Products Behavior](https://documentation.spryker.com/docs/en/restricted-products-behavior) page.)
