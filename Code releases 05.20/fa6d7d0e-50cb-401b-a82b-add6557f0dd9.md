...
**Documentation**
For integration guides, see [Cart Integration](https://documentation.spryker.com/docs/en/en/cart-integration). 
...
**Documentation**
For relevant documentation, see [CMS Block](https://documentation.spryker.com/docs/en/en/cms-block).

For detailed migration guides, see [CMS Migration Guide](https://documentation.spryker.com/docs/en/en/mg-cms), [CMS Block Migration Console](https://documentation.spryker.com/docs/en/en/mg-cms-block-category-connector-console)
...
**Documentation**
For relevant documentation, see [Product Label Module Guide](https://documentation.spryker.com/docs/en/en/product-label), [Discount Module Guide](https://documentation.spryker.com/docs/en/en/discount)
...
**Documentation**
For module documentation, see [Payment Module Guide](https://documentation.spryker.com/docs/en/en/payment)
For detailed migration guides, see [Payment Migration Guide](https://documentation.spryker.com/docs/en/en/mg-payment)
