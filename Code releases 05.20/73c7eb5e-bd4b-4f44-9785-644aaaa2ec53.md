...
| --- | --- | --- |
| Spryker Core | master | [Glue Application](https://documentation.spryker.com/docs/en/en/glue-application-feature-integration-201907) |
| Cart | master | [Cart API](https://documentation.spryker.com/docs/en/en/cart-feature-integration) |
| Customer Account Management | master | |
| Payments | master | [Payments API](https://documentation.spryker.com/docs/en/en/payments-api-feature-integration-201907) |
|Shipments| master | [Shipments API](https://documentation.spryker.com/docs/en/en/glue-api-shipment-feature-integration) | 
...
For more details, see [Updating Payment Data](https://documentation.spryker.com/docs/en/en/checking-out-purchases-and-getting-checkout-data-201907#updating-payment-data).
...
| Feature | Link |
| --- | --- |
| Shipment API | [Glue API: Shipment Feature Integration](https://documentation.spryker.com/docs/en/en/glue-api-shipment-feature-integration) |
| Payments API | [Glue API: Payments Feature Integration](https://documentation.spryker.com/docs/en/en/glue-api-payments-feature-integration) |
