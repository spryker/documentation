...
To start updating the product, go to the **Products** > **Products** section.
***
...
3. In the **Variants** tab, perform the actions described in  [Updating a Product Variant](https://documentation.spryker.com/v4/docs/updating-a-product-variant). 
