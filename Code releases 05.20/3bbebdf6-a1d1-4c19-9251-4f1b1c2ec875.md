...
3. In the **Variants** tab, perform the actions described in  [Updating a Product Variant](https://documentation.spryker.com/docs/en/en/updating-a-product-variant). 
