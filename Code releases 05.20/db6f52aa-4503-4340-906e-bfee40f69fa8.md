...
@(Info)()(See [Permissions Management for Shared Shopping Lists](https://documentation.spryker.com/docs/en/printing-shopping-list) to learn more about types of shopping list access rights.)
