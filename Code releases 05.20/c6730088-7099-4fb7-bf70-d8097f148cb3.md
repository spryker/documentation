...
## Installation
For detailed information on how to enable the functionality and related instructions, see [Glue API: Customer Access Feature Integration](https://documentation.spryker.com/docs/en/en/glue-customer-access-feature-integration).

## Usage
To retrieve a list of protected resources, send a GET request to the following endpoint:

**[/customer-access](https://documentation.spryker.com/docs/en/en/rest-api-reference#/customer-access/get_customer_access)**
