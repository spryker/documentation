...
Shopping lists are available in B2B scenarios only. This means that access to them is provided upon proper authentication as a **Company User**. For more details, see [Logging In as Company User](https://documentation.spryker.com/v5/docs/logging-in-as-company-user-201907).
:::
...
Find all the related attribute descriptions in [Accessing All Shopping Lists of a Company User](https://documentation.spryker.com/v5/docs/en/managing-shopping-lists#accessing-all-shopping-lists-of-a-company-user).
...
| Status code | Reason |
| --- | --- |
| 400 | The provided access token is not an [access token of a Company User](https://documentation.spryker.com/v5/docs/logging-in-as-company-user-201907). </br>**OR** </br> The shopping list ID is not specified. |
