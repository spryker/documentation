...
To start working with the configurable bundle templates, go to **Products** > **Configurable Bundle Templates**.
...
* To learn about the attributes you select and enter while creating a product list, see [Configurable Bundle Templates: Reference Information](https://documentation.spryker.com/v4/docs/configurable-bundle-templates-reference-information).