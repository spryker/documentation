...
A content manager can apply this template when [creating a CMS page](https://documentation.spryker.com/docs/en/en/creating-a-cms-page) in the Back Office.

## Template with Slots

[Template with slots](https://documentation.spryker.com/docs/en/en/templates-slots-feature-overview) is a Twig file that defines the layout of slots across a Storefront page and has at least one slot assigned. 
...
2. For each slot that you want to have in the template, insert a [slot widget](https://documentation.spryker.com/docs/en/en/templates-slots-feature-overview#slot-widget). 

3. [Import](https://documentation.spryker.com/docs/en/en/data-importers-review-implementation) template and slot lists. Learn about the lists in the [Correlation](https://documentation.spryker.com/docs/en/en/templates-slots-feature-overview#correlation) section of **Templates & Slots Feature Overview**.

Templates with slots are universal. In the Back Office, a content manager can:

*     apply this template when [creating a CMS page](https://documentation.spryker.com/docs/en/en/creating-a-cms-page).
*     apply this template when [creating a category](https://documentation.spryker.com/docs/en/en/creating-categories).
...
CMS block template is a Twig file that, when applied to a [CMS block](https://documentation.spryker.com/docs/en/en/cms-block), defines its design and layout. 
...
A content manager can apply this template when [creating a CMS block](https://documentation.spryker.com/docs/en/en/creating-cms-block) in the Back Office.

## Content Item Widget Template

[Content item widget](https://documentation.spryker.com/docs/en/en/content-items-widgets-overview) template is a Twig file that defines the layout of the content item it renders on Storefront.
