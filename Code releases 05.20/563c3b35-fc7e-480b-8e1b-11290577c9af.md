...
@(Info)(Info)(You can assign multiple categories to a product list.)
3. Click Save.
...
Review [Product Lists: Reference Information](https://documentation.spryker.com/docs/en/en/product-lists-reference-information) to learn about the attributes you see, select, and enter while managing a product list.
