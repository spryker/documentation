...
:::
5. Since the default Spryker PHp image has been upgraded, edit the `deploy.yml` file on the 7th line to use specific image that is working with this release of the Demo Shop:
from
```shell
