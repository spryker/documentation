This document describes the procedure of installing Spryker in [Demo Mode](https://documentation.spryker.com/docs/en/en/modes-overview#demo-mode).

:::(Warning) ()
Before you start, make sure to fulfill the [prerequisites](https://documentation.spryker.com/docs/en/en/docker-installation-prerequisites).
:::
...
1. Open a terminal.
@(Info)()(In case you are going to run the script on Windows, open Ubuntu (For more details, see the *Install Docker Desktop* section in [Docker Installation Prerequisites - Windows](https://documentation.spryker.com/docs/en/en/docker-installation-prerequisites-windows).))
2. Create a new folder and navigate into this folder.
3. Depending on the desired [Demo Shop](https://documentation.spryker.com/docs/en/en/en/about-spryker#spryker-b2b-b2c-demo-shops):
...
@(Info)()(Use "spryker" as a username and "secret" as a password. These credentials are defined and can be changed in `deploy.yml`.)
...
**What's next?**
* [Troubleshooting](https://documentation.spryker.com/docs/en/en/troubleshooting)
* [Debugging Setup in Docker](https://documentation.spryker.com/docs/en/en/debugging-setup-in-docker)
...
* [Self-signed SSL Certificate Setup](https://documentation.spryker.com/docs/en/en/self-signed-ssl-certificate-setup) 
