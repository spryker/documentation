Slots are used to embed content into pages to which [templates with slots](https://documentation.spryker.com/docs/en/en/templates-slots-feature-overview ) are applied.
