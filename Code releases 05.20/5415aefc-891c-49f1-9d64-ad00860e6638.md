...
### Supported browsers
The Spryker Commerce OS supports the following browsers for all frontend-related projects/products ([B2B Demo Shop](https://documentation.spryker.com/v5/docs/b2b-suite), [B2C Demo Shop](https://documentation.spryker.com/v5/docs/b2c-suite), [Master Suite](https://documentation.spryker.com/v5/docs/master-suite)):
