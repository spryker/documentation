...
### Supported browsers
The Spryker Commerce OS supports the following browsers for all frontend-related projects/products ([B2B Demo Shop](https://documentation.spryker.com/docs/en/demoshops#b2b-demo-shop), [B2C Demo Shop](https://documentation.spryker.com/docs/en/demoshops#b2c-demo-shop), [Master Suite](https://documentation.spryker.com/docs/en/demoshops#master-suite)):
