...
A role includes a set of permissions that can be enabled/disabled according to your needs by switching the toggle in **Enable** column. See [Company Roles: Reference Information](https://documentation.spryker.com/docs/en/en/company-roles-reference-information) to learn the permissions you can assign/unassign.
3. Click **Submit**.
***
...
Don't forget to check out the video tutorial on setting up the [Company Roles](https://documentation.spryker.com/docs/en/en/company-roles-permissions-overview) in Spryker [B2B Demo Shop](https://documentation.spryker.com/docs/en/en/b2b-suite):
...
To learn how to assign a role to a company user, see [Editing the existing User in Shop Guide - Company Users](https://documentation.spryker.com/docs/en/en/company-users-shop-guide#editing-an-existing-company-user)