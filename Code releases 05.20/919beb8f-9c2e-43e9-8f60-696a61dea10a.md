This document describes the procedure of generating images and assets suitable for a [production environment](https://documentation.spryker.com/docs/en/en/installation-modes#running-production). After going through all the steps, it's up to you how to proceed further.
