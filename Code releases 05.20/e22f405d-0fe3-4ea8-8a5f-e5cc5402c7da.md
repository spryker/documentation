...
| **Select your CSV file** | Here, you can select the file with price product schedules which you want to import. See [HowTo - Import Scheduled Prices]( https://documentation.spryker.com/docs/en/en/ht-import-scheduled-prices-201907) to learn more about the file format. |
...
@(Info)()(Since **View Import and Edit Import** pages have almost the same attributes, you can use the attributes in this section while both viewing and editing imports.)
