...
@(Warning)()(timeout = ((current_timestamp - session_started_at) - (session_lifetime - refresh_before_session_end)) * -1)

For example:

@(Info)()(current time: 10:00 (1543399200)<br>session lifetime: 30m (18000)<br>session started at: 9:35 (1543397700)<br>session refresh before end: 5m (300)<br>((1543399200 - 1543397700) - (1800-300))*-1 = 0)
...
@(Info)()(By default, session lifetime value is 30 minutes while session check is set to be performed 5 minutes prior to the session timeout.)
