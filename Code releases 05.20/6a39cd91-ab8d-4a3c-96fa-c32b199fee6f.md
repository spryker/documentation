...
To start working with product labels, go to **Products** > **Product Labels**.
...
* To learn how the product labels are managed, see [Managing Product Labels](https://documentation.spryker.com/v4/docs/managing-product-labels). 
