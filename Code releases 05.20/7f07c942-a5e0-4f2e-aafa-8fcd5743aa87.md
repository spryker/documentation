...
1. Upgrade the `Content` module to version 2.0.0. See [Migration Guide - Content](https://documentation.spryker.com/docs/en/en/mg-content-201907) for more details.
