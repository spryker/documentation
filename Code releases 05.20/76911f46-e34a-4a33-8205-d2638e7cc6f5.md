...
* [buyer workflow](https://documentation.spryker.com/docs/en/en/quotation-process-rfq-feature-overview-201907#buyer-workflow)
* [sales representative workflow](https://documentation.spryker.com/docs/en/en/quotation-process-rfq-feature-overview-201907#sales-representative-workflow)
...
* via an [Agent](https://documentation.spryker.com/docs/en/en/agent-assist) Account
...
To create an RFQ on behalf of a user, see [Creating an RFQ for a Customer](https://documentation.spryker.com/docs/en/en/managing-rfqs-sales-rep-shop-guide#creating-an-rfq-for-a-customer)
