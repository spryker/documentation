...
2. On the **Create Tax Rate** page, enter and select the attributes. See [Taxes: Reference information](https://documentation.spryker.com/docs/en/en/taxes-reference-information) for more details.
3. Click **Save**.
...
2. On the **Edit Tax Rate** page, change the attributes. See [Taxes: Reference information](https://documentation.spryker.com/docs/en/en/taxes-reference-information) for more details.
3. Click **Save**.
...
2. On the **Create Tax Set** page, enter the tax set name and select one or several tax rates to assign. See [Taxes: Reference information](https://documentation.spryker.com/docs/en/en/taxes-reference-information) for more details.
3. Click **Save**.
...
2. On the **Edit Tax Set** page, change the attributes. See [Taxes: Reference information](https://documentation.spryker.com/docs/en/en/taxes-reference-information) for more details.
3. Click **Save**.
