...
@(Info)()(To find out more information about the attributes that you see on the **Edit Discount** page, see [Discount: Reference Information](https://documentation.spryker.com/docs/en/en/discount-reference-information).)
...
1. On the **Overview of Discounts** page, click **Add code** in the _Actions_ column.
    ...
    Follow the steps described in [Creating a Discount Voucher](https://documentation.spryker.com/docs/en/en/creating-a-discount-voucher).
