To install the Demo Shop for B2B implementations without Development Virtual Machine, follow the steps below.
...
* Elasticsearch v5.x (preferably v5.6.x) or v6.x (v7.x isn't supported)
