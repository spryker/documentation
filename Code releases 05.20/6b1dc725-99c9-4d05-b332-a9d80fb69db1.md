...
This will take you to the **Product Availability** page. See [Availability: Reference Information](https://documentation.spryker.com/docs/en/en/availability-reference-information) for more details.
...
@(Warning)(Note)(Please note that you are updating the product variant availability, not the bundle availability itself. To see examples on how the bundle availability is calculated, see [Availability: Reference Information](https://documentation.spryker.com/docs/en/en/availability-reference-information).)
***
**Tips & Tricks**
