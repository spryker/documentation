...
:::(Info) (Info)
To identify the data for your import file, you can also check out the .csv files of individual data importers listed in [Demo Shop Data Import Categories](https://documentation.spryker.com/docs/demo-shop-data-import-categories). 
:::
...
@(Info)(Steps)((Each importer needs at least one step to write the data from the file to a database. You can add as many steps as you need to your `DataSetStepBroker`.)
