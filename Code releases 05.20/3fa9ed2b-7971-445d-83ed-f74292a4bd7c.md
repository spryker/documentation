...
Review [Configurable Bundle Templates: Reference Information](https://documentation.spryker.com/docs/en/en/configurable-bundle-templates-reference-information) to learn about the attributes you see, select, and enter while managing a template.
