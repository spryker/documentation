...
| --- | --- | --- |
| Spryker Core | master | [Glue Application Feature Integration](https://documentation.spryker.com/docs/en/en/glue-application-feature-integration-201907) |
| Company account | master | [Company Account](https://documentation.spryker.com/docs/en/en/company-account-integration-201907) |
| Customer Account Management | muster | [Customer API](https://documentation.spryker.com/docs/en/en/customer-account-management-feature-integration-glue-201907) |
