...
Build on top of Symfony components and uses Twig as its templating engine. It has no connection to the database in Zed.
...
### Zed
Zed is more of a heavy-duty back-end application. Like Yves, its build on top of Symfony components and uses Twig. Zed main purpose is to take care of business logic, persistent data, and to connect to external systems.
