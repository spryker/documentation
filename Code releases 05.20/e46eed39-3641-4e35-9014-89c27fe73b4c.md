...
For a detailed list of the fields included in the response for each product, see [General Product Information](https://documentation.spryker.com/docs/retrieving-product-information#retrieve-abstract-products).
...
@(Info)()(For details on peculiarities of managing carts of registered users, see [Managing Carts of Registered Users](https://documentation.spryker.com/docs/managing-carts-of-registered-users).)
...
@(Info)()(For details on how to retrieve and manage the identifier, see [Managing Guest Carts](https://documentation.spryker.com/docs/managing-guest-carts).)
