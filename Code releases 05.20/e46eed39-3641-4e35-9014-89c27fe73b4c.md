...
@(Info)()(Only [abstract](https://documentation.spryker.com/docs/en/en/product-abstraction) products support Product Relations. For more details, see [Product Relations](https://documentation.spryker.com/docs/en/en/product-relations).)
...
@(Info)()(To be able to use **Product Relations API**, first, you need to have the Product Relations feature integrated with your project. For details, see [Product Relation Integration](https://documentation.spryker.com/docs/en/en/glue-api-product-relations-feature-integration).)
...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [GLUE API: Product Relations Feature Integration](https://documentation.spryker.com/docs/en/en/glue-api-product-relations-feature-integration).
...
| Path parameter | Description |
| --- | --- |
| ***{{cart_id}}}*** | ID of a cart to get upselling items of. [Retrieve all carts](https://documentation.spryker.com/docs/en/en/managing-carts-of-registered-users#retrieve-all-carts) to get it. | 
...
|---|---|---|---|
| X-Anonymous-Customer-Unique-Id | 164b-5708-8530 | ✓ | A hyphenated alphanumeric value that is the user's unique identifier. This value is passed as a header when [creating a guest cart](https://documentation.spryker.com/docs/en/en/managing-guest-carts#creating-a-guest-cart). | 
