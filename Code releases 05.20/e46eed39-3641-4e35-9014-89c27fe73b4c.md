...
@(Info)()(Only [abstract](https://documentation.spryker.com/docs/en/product-abstraction) products support Product Relations. For more details, see [Product Relations](https://documentation.spryker.com/docs/en/product-relations).)
...
@(Info)()(To be able to use **Product Relations API**, first, you need to have the Product Relations feature integrated with your project. For details, see [Product Relation Integration](https://documentation.spryker.com/docs/en/glue-api-product-relations-feature-integration).)
...
| Path parameter | Description |
| --- | --- |
| ***{{cart_id}}}*** | ID of a cart to get upselling items of. [Retrieve all carts](https://documentation.spryker.com/docs/en/managing-carts-of-registered-users#retrieve-all-carts) to get it. | 
