...
3. Make changes to the needed attributes. See [Content Items: Reference Information](https://documentation.spryker.com/docs/en/en/content-items-reference-information) to learn more about content item attributes. 
...
* To learn more about how to add content item widgets to a block or a page, see [Adding Content Item Widgets to Pages and Blocks](https://documentation.spryker.com/docs/en/en/adding-content-item-widgets-to-pages-and-blocks).