...
@(Warning)()(For more information on route plugins, see the [Resource Routing](https://documentation.spryker.com/docs/en/glue-infrastructure#resource-routing) section in **Glue Infrastructure**.)
