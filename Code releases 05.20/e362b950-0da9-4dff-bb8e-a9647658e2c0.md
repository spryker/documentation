...
@(Warning)()(For more information on route plugins, see the [Resource Routing](https://documentation.spryker.com/docs/en/en/glue-infrastructure#resource-routing) section in **Glue Infrastructure**.)
