Both [invoice](https://documentation.spryker.com/docs/en/en/payolution-invoice) and [installment](https://documentation.spryker.com/docs/en/en/payolution-installment) payemnt methods utilize the same request flow. It basically consists of the following requests:
...
See Payolution - [Performing Requests](https://documentation.spryker.com/docs/en/en/payolution-requests) for detailed information on the requests.