...
* [Releases](https://documentation.spryker.com/docs/en/en/releases)
* [Release Notes 2018.11.0](https://documentation.spryker.com/docs/en/en/release-notes-2018-11-0)
* [Security Updates](https://documentation.spryker.com/docs/en/en/security-updates)

To check our previous release notes, go to the [Releases Archive](https://documentation.spryker.com/docs/en/en/releases-archive) section.
