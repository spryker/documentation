...
See [Product Relations: Reference Information](https://documentation.spryker.com/docs/en/en/product-relations-reference-information) to learn about the attributes used while editing a product relation.
...
**What's next?**
To learn about the attributes that you select and enter while managing product relations, see [Product Relations: Reference Information](https://documentation.spryker.com/docs/en/en/product-relations-reference-information).
