...
To learn more about the differences in the access levels, check the [Shared Carts Feature Overview](https://documentation.spryker.com/docs/en/en/shared-cart-overview).
