...
See [Shop Guide - Cancelling Orders](https://documentation.spryker.com/docs/shop-guide-cancelling-orders) to learn how B2B and B2C shoppers can cancel orders on the Storefront.
