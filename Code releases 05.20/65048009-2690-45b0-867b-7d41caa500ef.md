...
:::(Info) ()
For use cases and exmaple of each of the content item, see [Content Item Widgets types: Reference Information](https://documentation.spryker.com/docs/content-item-widgets-types-reference-information).
:::

A content manager can [create content items](https://documentation.spryker.com/v4/docs/creating-content-items) in the Back Office > **Content Management** > **Content Items** section. 
...
You can insert a content item widget into a CMS block or a CMS page by selecting a respective content item in the [WYSIWYG editor](https://documentation.spryker.com/docs/wysiwyg-editor) drop-down menu: 
