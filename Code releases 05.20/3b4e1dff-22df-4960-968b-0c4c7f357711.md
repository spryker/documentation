...
The following table describes the attributes on the *Create/Edit Content Item: Banner* pages:
...
The following table describes the attributes on the *Create/Edit Content Item: Abstract Product List* pages:
...
The following table describes the attributes on the *Create/Edit Content Item: Product Set* pages:
...
The following table describes the attributes on the *Create/Edit Content Item: File List* pages:
