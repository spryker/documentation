To install the [Demo Shop for B2B implementations](https://documentation.spryker.com/docs/en/b2b-suite) on Windows, with Development Virtual Machine, follow the steps below.
