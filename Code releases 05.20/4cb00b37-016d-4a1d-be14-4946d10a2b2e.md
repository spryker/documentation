...
:::(Info) ()
For details, see [Checking Out Purchases and Getting Checkout Data](https://documentation.spryker.com/docs/en/en/checking-out-purchases-and-getting-checkout-data-201907).
:::
...
:::(Info) ()
For details, see [Updating Payment Data](https://documentation.spryker.com/docs/en/en/checking-out-purchases-and-getting-checkout-data-201907#UpdatingPaymentData).
:::
