...
To start working with attributes, go to **Products > Attributes**.
...
Review the [References](https://documentation.spryker.com/v4/docs/attributes-reference-information) section to learn more about the attributes you populate for the Attribute entity and the examples of how the attributes are used. 