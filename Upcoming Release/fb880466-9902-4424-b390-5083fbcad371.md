This article contains content of the **shipment.csv** file to configure [Shipment](https://documentation.spryker.com/docs/shipment) information on your Spryker Demo Dhop.
