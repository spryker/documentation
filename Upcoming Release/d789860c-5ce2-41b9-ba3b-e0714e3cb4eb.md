This article contains content of the **customer.csv** file to configure [Customer](https://documentation.spryker.com/docs/crm) information on your Spryker Demo Dhop.
