This article contains content of the **currency.csv** file to configure [Currency](https://documentation.spryker.com/docs/multiple-currencies-per-store) information on your Spryker Demo Dhop.
