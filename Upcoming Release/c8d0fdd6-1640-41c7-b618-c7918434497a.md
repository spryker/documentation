...
* See [Buyer Workflow](https://documentation.spryker.com/docs/v5/quotation-process-rfq-feature-overview-201907#buyer-workflow) for more information on the request statuses and the workflow.
* See [Reference Information](https://documentation.spryker.com/docs/v5/rfq-reference-information-shop-guide) for details on UI elements in the **Quote Requests** page in the Customer Account.
...
See [Managing RFQs](https://documentation.spryker.com/v5/docs/managing-rfqs-for-buyer-shop-guide) to learn how you can perform these actions.