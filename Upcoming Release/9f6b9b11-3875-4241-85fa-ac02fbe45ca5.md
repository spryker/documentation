...
* [Carts API](https://documentation.spryker.com/v3/docs/cart-feature-integration).
<!-- * Glue API: Product Measurement Units Feature Integration --> 
...
| --- | --- | --- |
| include | Adds resource relationships to the request. | items, concrete-products, cart-permission-groups, product-measurement-units, sales-units |
...
Request sample: `POST http://glue.mysprykershop.com/carts/61ab15e9-e24a-5dec-a1ef-fc333bd88b0a/items?include=sales-units,product-measurement-units`
