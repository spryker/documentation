...
@(Info)(Cart types)(The following document covers the APIs for carts for **registered customers** only. If you want to know how to access carts of unregistered users, see [Managing Guest Carts](https://documentation.spryker.com/docs/managing-guest-carts).)

## Multiple Carts

Unlike guest carts, carts of registered users have unlimited lifetime. Also, if the Multiple Carts feature is [integrated into your project](https://documentation.spryker.com/docs/multiple-carts-feature-integration-201903){target="_blank"} and Glue is [enabled for multi-cart operations](https://documentation.spryker.com/docs/multiple-carts-feature-integration-201903){target="_blank"}, registered users can have unlimited number of carts.
...
---
`GET` **/carts/*{{cart_uuid}}*/items/*{{concreteproductsku}}***
