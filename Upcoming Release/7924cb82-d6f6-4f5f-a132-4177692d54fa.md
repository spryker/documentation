...
| idCart | string | v | ID of the customer's cart.</br>For details, see [Managing Carts of Registered Users](https://documentation.spryker.com/v4/docs/managing-carts-of-registered-users-201907){target="_blank"}. |
