...
| --- | --- | --- |
| Spryker Core | master | [Glue Application Feature Integration](https://documentation.spryker.com/docs/glue-spryker-core-feature-integration) |
| Product | master | [Products Feature Integration](https://documentation.spryker.com/docs/products-feature-integration) |
...
| `ConcreteProductBySkuResourceRelationshipPlugin` | Adds the `concrete-products` resource as a relationship to the `items` and `guest-cart` resources. | None | `Spryker\Glue\ProductsRestApi\Plugin\GlueApplication` |
