This article contains content of the **glossary.csv** file to configure [Customer](https://documentation.spryker.com/docs/glossary) information on your Spryker Demo Dhop.
