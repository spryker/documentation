...
Find all the related attribute descriptions in Accessing All Shopping Lists of a Company User [LINK].
...
| concrete-products | attributes | Array |  	List of attribute keys and their values for the product. |
