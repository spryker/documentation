...
***
To start working with product relations, navigate to **Products > Product Relations**.
***
...
2. In  the **General** section of the **Settings** tab, do the following:
    ...
    * Select the **Update regularly** checkbox for the product relation to be updated automatically according to the product relation's conditions.
