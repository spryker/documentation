...
* [B2B Demo Shop](https://documentation.spryker.com/v4/docs/demoshops#b2b-demo-shop) - a boilerplate for B2B commerce projects;
* [B2C Demo Shop](https://documentation.spryker.com/v4/docs/demoshops#b2c-demo-shop) - a starting point for B2C implementations;
