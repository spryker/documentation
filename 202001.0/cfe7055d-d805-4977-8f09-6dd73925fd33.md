...
@(Info)(Info)(This step will publish tables on change (create, edit, delete) to the `spy_product_alternative_storage`, `spy_product_replacement_for_storage`  and synchronize the data to Storage.)
