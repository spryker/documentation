...
The modules combine to create [features](https://documentation.spryker.com/v4/docs/features) and have limited dependencies. The limited dependencies imply less development effort, increasing your return on investment and lowering the total cost of ownership.
