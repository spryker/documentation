@(Warning)(Product Customization)(This article describes flow of the product data from importing it to the SQL database to showing it in the front-end view.)
