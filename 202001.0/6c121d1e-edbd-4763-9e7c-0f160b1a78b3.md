To install the [Demo Shop for B2C implementations](https://documentation.spryker.com/v4/docs/b2c-suite) on Windows with Development Virtual Machine, follow the steps below.
