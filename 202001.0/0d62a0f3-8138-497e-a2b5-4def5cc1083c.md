...
If you are using Propel mapping behavior and you want to re-synchronize your data with mapping keys, than you need to overrite SynchronizationBehaviorConfig on project level:
...
class SynchronizationBehaviorConfig extends SprykerSynchronizationBehavior
{
    /**
     * @return bool
     */
