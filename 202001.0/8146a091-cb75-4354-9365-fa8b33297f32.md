...
To know more about the attributes you see, select, and enter while creating a customer, see [Customers: Reference Information](https://documentation.spryker.com/v4/docs/customers-reference-information). 
...
To know how the customer addresses are managed, see  [Managing Customer Addresses](https://documentation.spryker.com/v4/docs/customers-reference-information).
