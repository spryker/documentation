...
#### Documentation
[Discounts API](https://documentation.spryker.com/docs/discounts-and-promotions) 
...
* [Deploy File Reference](https://documentation.spryker.com/v4/docs/deploy-file-reference-version-1-201907#deploy-file-reference---1-0)
* [Spryker in Docker Services](https://documentation.spryker.com/v4/docs/spryker-in-docker-services)
...
#### Documentation: 
[Search Migration Guides](https://documentation.spryker.com/docs/search-migration-concept)
...
#### Documentation:
[Silex Migration Guides](https://documentation.spryker.com/docs/silex-replacement-201903)
