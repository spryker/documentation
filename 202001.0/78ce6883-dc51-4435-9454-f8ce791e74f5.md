...
|---|---|---|
|Spryker Core|202001.0|[Glue Application](https://documentation.spryker.com/docs/glue-application-feature-integration-201907)|
|Product Relation|202001.0||
|Cart|202001.0| [Cart API](https://documentation.spryker.com/docs/cart-feature-integration-201907) ||
Product|202001.0|[Products API](https://documentation.spryker.com/docs/products-feature-integration-201907)|
