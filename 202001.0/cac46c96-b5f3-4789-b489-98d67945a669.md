...
@(Warning)(Note)(By default, all Spryker customers are assigned to the customer scope.)
...
@(Info)(Info)(B2B functionality is available in Spryker Glue API since version 201907.0.)
...
@(Info)()(For details, see [Resource Routing](https://documentation.spryker.com/v4/docs/glue-infrastructure#resource-routing){target="_blank"}.)
