...
class AdyenExecute3DStep extends AbstractBaseStep
{
    ...
    {
        return ($this->isAdyenCreditCardPayment($quoteTransfer) && $this->config->isAdyenCreditCard3dSecureEnabled() && $quoteTransfer->getPayment()->getAdyenRedirect());
    }
     ...
     * @return bool
     */
    private function isAdyenCreditCardPayment(AbstractTransfer $quoteTransfer): bool
    {
