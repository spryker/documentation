...
`http://glue.mysprykershop.com/abstract-products/{{abstract_sku}}/product-reviews`
<details open>
...
<details open>
<summary>src/Pyz/Glue/ProductsRestApi/ProductsRestApiDependencyProvider.php</summary>
...
:::(Warning) (Verification)
Make a request to `http://glue.mysprykershop.com/abstract-products/{{abstract_sku}}?include=product-reviews`.
...
:::(Warning) (Verification)
Make a request to `http://glue.mysprykershop.com/concrete-products/{{concrete_sku}}?include=product-reviews`.
