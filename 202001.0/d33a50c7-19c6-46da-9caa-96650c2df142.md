To install the [Demo Shop for B2B implementations](https://documentation.spryker.com/v4/docs/b2b-suite) on Mac OS or Linux with Development Virtual Machine, follow the steps below.
