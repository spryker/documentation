...
Yes. Like iOS or MacOS, Spryker is an operating system that offers a range of features. These features are grouped into capabilities that are composed of features. Just as iOS notepad and calendar apps, you can use Spryker features as is, or extend them for your business needs. As such, Spryker as an operating system offers both turn-key features and its own demo apps as bases.
