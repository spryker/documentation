This document describes the procedure of installing Spryker in [Demo Mode](ttps://documentation.spryker.com/v4/docs/modes-overview#demo-mode).
...
1. Open a terminal.
@(Info)()(In case you are going to run the script on Windows, open Ubuntu (For more details, see the *Install Docker Desktop* section in [Docker Installation Prerequisites - Windows](https://documentation.spryker.com/v4/docs/docker-installation-prerequisites-windows).))
...
3. Depending on the desired [Demo Shop](https://documentation.spryker.com/v4/docs/demoshops):
    ...
    ```
4. Clone the docker repository into the same folder:
```shell
