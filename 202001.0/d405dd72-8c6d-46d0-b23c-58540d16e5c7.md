...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Glue API: Products Feature Integration](https://documentation.spryker.com/v4/docs/glue-api-products-feature-integration).
