...
| --- | --- | --- |
| Spryker Core | 202001.0 | [Glue Application Feature Integration](https://documentation.spryker.com/v4/docs/glue-api-glue-application-feature-integration) |
...
2. Create validation configuration:
    ...
    b. In the file, describe validation rules for endpoints. See see [Validating REST Request Format](https://documentation.spryker.com/v4/docs/validating-rest-request-format) for more details. Example:
