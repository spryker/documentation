...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Glue API: Navigation Feature Integration](https://documentation.spryker.com/v4/docs/glue-api-navigation-feature-integration).
