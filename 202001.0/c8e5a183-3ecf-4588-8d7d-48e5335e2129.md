...
*   [ErrorHandler](https://documentation.spryker.com/v4/docs/migration-guide-errorhandler)
*   [EventDispatcher](https://documentation.spryker.com/v4/docs/migration-guide-eventdispatcher)
*   [Form](https://documentation.spryker.com/v4/docs/migration-guide-form)
*   [Http](https://documentation.spryker.com/v4/docs/migration-guide-http)
*   [Locale](https://documentation.spryker.com/v4/docs/migration-guide-locale)
*   [Propel](https://documentation.spryker.com/v4/docs/migration-guide-propel)
*   [Messenger](https://documentation.spryker.com/v4/docs/migration-guide-messenger)
*   [Router](https://documentation.spryker.com/v4/docs/migration-guide-router)
*   [Security](https://documentation.spryker.com/v4/docs/migration-guide-security)
*   [Session](https://documentation.spryker.com/v4/docs/migration-guide-session)
*   [Store](https://documentation.spryker.com/v4/docs/migration-guide-store)
*   [Translator](https://documentation.spryker.com/v4/docs/migration-guide-translator)
*   [Twig](https://documentation.spryker.com/v4/docs/migration-guide-twig)
*   [Validator](https://documentation.spryker.com/v4/docs/migration-guide-validator)
*   [WebProfiler](https://documentation.spryker.com/v4/docs/migration-guide-webprofiler)
