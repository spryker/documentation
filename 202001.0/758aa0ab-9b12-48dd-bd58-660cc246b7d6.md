...
@(Info)()(See  [Migration Guide - PriceProduct](https://documentation.spryker.com/v4/docs/mg-priceproduct) for information on how to migrate to a newer version of the `PriceProduct` module with price dimensions support.)