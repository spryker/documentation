...
4.  You need to choose the security group for all services/instances that you will create following this instruction.
...
3. Fill out all the outlined fields. 
   Choose a use case ( For production purpose, we recommend Production deployment type).
...
1. Create or update following files using the provided templates:
...
sudo apt-get update
sudo apt-get install jenkins=2.164.3 openjdk-8-jdk
...
```
3. Create an init script which disabled CSRF **/var/lib/jenkins/init.groovy.d/init.groovy**
```
...
**/data/config/Shared/config_local_DE.php**
```
<?php
use Spryker\Shared\Application\ApplicationConstants;
use Spryker\Shared\Collector\CollectorConstants;
...
**/data/config/Shared/config_local_AT.php**
```
<?php
use Spryker\Shared\Application\ApplicationConstants;
use Spryker\Shared\Collector\CollectorConstants;
...
```
**/data/config/Shared/config_local_US.php**
```
<?php
use Spryker\Shared\Application\ApplicationConstants;
use Spryker\Shared\Collector\CollectorConstants;
