...
**Documentation**
For module documentation, see [Product Relation](https://documentation.spryker.com/v4/docs/product-relations). For integration guides see: [Product Relations Feature Integration](https://documentation.spryker.com/v4/docs/product-relation-integration).
