...
1.	On an article page, click **Edit or Report** under the title of the article.
2.	Click **Edit this file** in the top right menu and make the changes.  
...
3.	Once done, select **Create a new branch for this commit and start a pull request**. At the bottom of the page, give your branch a name and click **Commit changes**.
