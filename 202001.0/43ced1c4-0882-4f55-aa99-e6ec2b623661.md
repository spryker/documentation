...
@(Warning)(Verification)(Verify that, as a customer, on quote request edit page, you can edit following fields:<ul><li>Purchase Order Number</li><li>DeliveryDate</li><li>Note</li><ul>)
...
@(Warning)(Verification)(Verify that, as an agent, on quote request edit page, you can edit following fields: <ul><li>Purchase Order Number</li><li>DeliveryDate</li><li>Note</li><ul>)
