To install the [Demo Shop for B2C implementations](https://documentation.spryker.com/docs/b2c-suite) without Development Virtual Machine, follow the steps below.
