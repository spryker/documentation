...
AvailabilityStorage publishes all availability information for abstract and concrete products. Items are grouped by abstract product. This process is handled by [Publish and Synchronize](https://documentation.spryker.com/v4/docs/publish-and-synchronization).
...
The Back Office is provided to allow assigning stocks to products. See [Availability](https://documentation.spryker.com/v4/docs/managing-products-availability) for details on how to manage product stocks in the Back Office.
