...
| --- | --- | --- | --- |
| X-Agent-Authorization | string | v | String containing digits, letters, symbols that authorized the agent assist. [Authenticate as an agent assist](https://documentation.spryker.com/docs/authenticating-as-an-agent-assist#authenticate-as-an-agent-assist) to get the value.  |
...
| 4102 | Agent access token is invalid. |
| 4103 | Action is available to agent user only. |
