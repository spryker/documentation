...
| 403 | Authentication token is missing.</br>- OR -</br>Current company account is not set. |
| 404 | Specified company was not found, or the current authenticated company user does not have access to it. |
