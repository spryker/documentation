...
* To share a carts with external and internal users via a link, see [Unique URL per Cart for Easy Sharing feature overview](https://documentation.spryker.com/docs/unique-url-per-cart-for-easy-sharing-overview).
...
* To add comments to add comments to a cart, see [Comments feature overview](https://documentation.spryker.com/docs/comments-feature-overview#comments-on-the-storefront).