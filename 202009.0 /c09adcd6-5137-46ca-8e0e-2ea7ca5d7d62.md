...
Shopping lists are available in B2B scenarios only. This means that access to them is provided upon proper authentication as a **Company User**. For more details, see [Logging In as Company User](https://documentation.spryker.com/docs/logging-in-as-company-user-201907).
:::
In your development, the resources can help you to enable the shopping list functionality in your application.

## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Glue API: Shopping Lists Feature Integration](https://documentation.spryker.com/docs/glue-api-shopping-lists-feature-integration).
...
| sku | String | yes | SKU of the product to add. Only [concrete products](https://documentation.spryker.com/docs/product-abstraction) are allowed. |
...
Find all the related attribute descriptions in [Accessing All Shopping Lists of a Company User](https://documentation.spryker.com/v5/docs/managing-shopping-lists#accessing-all-shopping-lists-of-a-company-user).
...
## Updating a quantity of items in a shopping list
...
| Attribute | Type | Required | Description|
| --- | --- | --- |--- |
| sku | String | yes |SKU of the product the quantity of which you want to change. Only [concrete products](https://documentation.spryker.com/docs/product-abstraction) are allowed. |
...
| Status code | Reason |
| --- | --- |
| 001 | The access token is incorrect. |
| 002 | The access token is missing. |
| 400 | The provided access token is not an [access token of a Company User](https://documentation.spryker.com/docs/logging-in-as-company-user-201907). |
| 422 | Could not create/update a shopping list.</br>**OR** </br>Could not add/update an item. |
| 1501 | The shopping list ID is not specified. |
| 1504 | The specified shopping list or shopping list item could not be found. |
