...
Find all the related attribute descriptions in [Retrieve shopping lists](#retrieve-shopping-lists).
...
| ***{{shopping_list_item_id}}*** | Unique identifier of a shopping list item to change the quantity of. To get it, [Add items to a shopping list](#add-items-to-a-shopping-list), [Retrieve shopping lists](#retrieve-shopping-lists), or [Retrieve a shopping list](#retrieve-a-shopping-list) with the `shopping-list-items` included. |
...
| PATH PARAMETER | DESCRIPTION |
| --- | --- |
| ***{{shopping_list_id}}*** | Unique identifier of a shopping list to delete items from. |
| ***{{shopping_list_item_id}}*** | Unique identifier of a shopping list item to remove. To get it, [Add items to a shopping list](#add-items-to-a-shopping-list), [Retrieve shopping lists](#retrieve-shopping-lists), or [Retrieve a shopping list](#retrieve-a-shopping-list) with the `shopping-list-items` included. |
...
| PATH PARAMETER | DESCRIPTION |
| --- | --- |
| ***{{shopping_list_id}}*** | Unique identifier of a shopping list to delete. To get it, [Retrieve shopping lists](#retrieve-shopping-lists). |
