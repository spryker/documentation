For B2B customers, being able to purchase a compound product is very important. Shoppers want to select and buy complicated sets of products in one place at once.e This is where the **Configurable Bundle** feature best suits the needs.

Configurable Bundle allows your customers to select components of a compound product: the compatible products with their properties like color or size. For example, if you are a car dealer, your customer may select the option of heated seats in their driver’s seat or an automatic start.


Configurable Bundles feature is usefulef when you want to:

* Simplify the configuration process of bundle products for customers.
