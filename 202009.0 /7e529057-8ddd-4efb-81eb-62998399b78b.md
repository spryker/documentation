...
| --- | --- | --- | --- |
| X-Anonymous-Customer-Unique-Id | 164b-5708-8530 | v | A guest user's unique identifier. For security purposes, we recommend passing a hyphenated alphanumeric value, but you can pass any. If you are sending automated requests, you can configure your API client to generate this value. |
...
| guest-cart-items | selectedProductOptions | array | A list of attributes describing the product options that were added to cart with the product. |
...
For more reqeust body examples, see [Add items to a guest cart](#add-items-to-a-guest-cart)
