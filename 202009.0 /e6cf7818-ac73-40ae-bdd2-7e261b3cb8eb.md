...
| --- | --- | --- | --- |
| refreshToken | String | v | Authentication token used to refresh `accessToken`. You can get it by [authenticating as a company user](https://documentation.spryker.com/docs/authenticating-as-a-company-user#authenticate-as-a-company-user). |
