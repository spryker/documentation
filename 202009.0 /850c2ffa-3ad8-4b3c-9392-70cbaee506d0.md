...
## Updating your project with the basic SEO techniques
In the Spryker Demo Shop, the microdata is implemented on the landing page only and has affected the following modules:
...
To update your project with the basic SEO techniques such as improved headings structure and use of microdata, update the necessary modules by running this command: 
