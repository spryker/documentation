...
## Updating your project with the basic SEO approaches
...
To update your project with the basic SEO approaches such as improved headings structure and use of microdata, update the necessary modules by running this command: 
