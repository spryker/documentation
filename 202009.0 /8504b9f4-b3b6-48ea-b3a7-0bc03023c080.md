...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Glue API: Wishlist feature integration](https://documentation.spryker.com/docs/glue-api-wishlist-feature-integration).
...
```json
{
    "data": [
        {
            ...
            "links": {
                "self": "https://glue.de.b2c.demo-spryker.com:80/wishlists/246591f8-4f30-55ce-8b17-8482859b4ac1?include=wishlist-items"
            },
            "relationships": {
                "wishlist-items": {
                    "data": [
    ...
    "links": {
        "self": "https://glue.de.b2c.demo-spryker.com:80/wishlists?include=wishlist-items"
    },
    "included": [
        {
            "type": "wishlist-items",
            ...
            "links": {
                "self": "https://glue.de.b2c.demo-spryker.com:80/wishlists/246591f8-4f30-55ce-8b17-8482859b4ac1/wishlist-items/149_28346778"
            }
        }
    ]
}
...
```json
{
    "data": [
        {
            ...
            "links": {
                "self": "https://glue.de.b2c.demo-spryker.com:80/wishlists/246591f8-4f30-55ce-8b17-8482859b4ac1?include=wishlist-items,concrete-products"
            },
            "relationships": {
                "wishlist-items": {
                    "data": [
    ...
    "links": {
        "self": "https://glue.de.b2c.demo-spryker.com:80/wishlists?include=wishlist-items,concrete-products"
    },
    "included": [
        {
            ...
            "links": {
                "self": "https://glue.de.b2c.demo-spryker.com:80/concrete-products/149_28346778"
            }
        },
        {
            "type": "wishlist-items",
...
```json
{
    "data": [
        {
            ...
            "links": {
                "self": "https://glue.de.b2c.demo-spryker.com:80/wishlists/246591f8-4f30-55ce-8b17-8482859b4ac1?include=wishlist-items,concrete-products,product-labels"
            },
            "relationships": {
                "wishlist-items": {
                    "data": [
    ...
    "links": {
        "self": "https://glue.de.b2c.demo-spryker.com:80/wishlists?include=wishlist-items,concrete-products,product-labels"
    },
    "included": [
        {
            "type": "product-labels",
        ...
        },
        {
            ...
            "links": {
                "self": "https://glue.de.b2c.demo-spryker.com:80/concrete-products/020_21081478"
            },
            "relationships": {
                "product-labels": {
                    "data": [
        ...
        },
        {
            ...
            "links": {
                "self": "https://glue.de.b2c.demo-spryker.com:80/wishlists/246591f8-4f30-55ce-8b17-8482859b4ac1/wishlist-items/020_21081478"
            },
            "relationships": {
                "concrete-products": {
                    "data": [
...
For attributes of included resources, see:
