...
| --- | --- | --- |
| id | String | A unique identifier that can be used to define permissions with this permission group. |
...
| Attribute | Type | Description |
| --- | --- | --- |
| id | String | A unique identifier that can be used to assign permissions with this permission group. |
| name | String | Permission group name. For example, `READ_ONLY` or `FULL_ACCESS`. |
| isDefault | Boolean | Defines if the permission group is applied to shared carts by default. |
...
* [Managing shared company users carts](https://documentation.spryker.com/docs/managing-shared-company-user-carts)