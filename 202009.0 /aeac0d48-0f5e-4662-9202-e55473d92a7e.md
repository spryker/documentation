...
```    
    ...
    <summary>Reponse sample with vouchers</summary>
...
For the attributes of carts of registered users, see [Retrieve a registered user's carts](#retrieve-a-registered-users-carts-response-attributes).
