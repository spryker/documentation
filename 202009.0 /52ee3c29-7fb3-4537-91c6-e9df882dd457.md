...
2. Adjust `config/Shared/common/config_oauth-development.php.
    * Remove `use Spryker\Shared\Auth\AuthConstants;`
    * Add `use Spryker\Shared\SecuritySystemUser\SecuritySystemUserConstants;`
    * Change 
    ```php
...
## Generate transfers
:::(Info) (Info)
This section helps you to generate transfers objects.
:::
...
## Update database
::::(Info) (Info)
This section helps you to generate new Propel classes.
:::
