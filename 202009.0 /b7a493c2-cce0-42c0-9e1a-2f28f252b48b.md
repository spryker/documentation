The *Product Barcode* can be used for any kind of entity, and by default, we provide a solution for products.
...
@(Info)()(You can read more about the product types we differentiate in [Product Abstraction](https://documentation.spryker.com/docs/product-abstraction).)
