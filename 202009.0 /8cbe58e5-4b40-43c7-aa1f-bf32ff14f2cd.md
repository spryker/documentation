Using the **Product Relations** feature, sellers can define a list of comparable or additional items for each product. You can display such items, also called Related Products, in search and in the cart together with the products selected by customers. This can help boost the cross- and up-selling performance of the outlet.

@(Info)()(Only [abstract](https://documentation.spryker.com/docs/product-abstraction) products support Product Relations. For more details, see [Product Relations](https://documentation.spryker.com/docs/product-relations).)
...
* Provide additional product items in a customer's cart to offer upscale variations, accessories, and other additional items for products in the cart. This will help you boost the cart value.

@(Info)()(To be able to use **Product Relations API**, first, you need to have the Product Relations feature integrated with your project. For details, see [Product Relation Integration](https://documentation.spryker.com/docs/glue-api-product-relations-feature-integration).)
...
---
`GET` **/abstract-products/*{{abstract_product_sku}}*/related-products**

---

| Path parameter | Description |
| --- | --- |
| ***{{abstract_product_sku}}*** | SKU of an abstract product to retrieve related products of. | 
...
---
`GET` **/carts/*{{cart_id}}*/up-selling-products**
...
| Path parameter | Description |
| --- | --- |
| ***{{cart_id}}}*** | ID of a cart to get upselling items of. [Retrieve all carts](https://documentation.spryker.com/docs/managing-carts-of-registered-users#retrieve-all-carts) to get it. | 
...
## Retrieving up-selling products of a guest cart
To get up-selling items for products in a guest cart, send the request:
`GET` **/guest-carts/*{{guest_cart_id}}*/up-selling-products**

| Path parameter | Description |
| --- | --- |
| ***{{guest_cart_id}}}*** | ID of a guest cart to get upselling items of.  | 


### Request
| Header key | Header value example | Required | Description | 
|---|---|---|---|
| X-Anonymous-Customer-Unique-Id | 164b-5708-8530 | ✓ | A guest user's unique identifier. For security purposes, we recommend passing a hyphenated alphanumeric value, but you can pass any. If you are sending automated requests, you can configure your API client to generate this value. | 
...
| 404 | Сart with the specified ID was not found. </br>Abstract product not found. |
