...
@(Warning)(Note)( ***No access*** is applied automatically to a newly-created cart.)
...
@(Warning)(Note)(With the ***Read-only*** permission, no cart actions are available to the user, except for adding comments and editing a custom order reference.)
