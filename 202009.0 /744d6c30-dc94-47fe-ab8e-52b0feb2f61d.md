...
| --- | --- | --- | --- |
| X-Anonymous-Customer-Unique-Id | 164b-5708-8530 | v | Guest user's unique identifier. The value should correspond to the value used when [creating the guest cart](https://documentation.spryker.com/docs/managing-guest-carts#create-a-guest-cart). |
