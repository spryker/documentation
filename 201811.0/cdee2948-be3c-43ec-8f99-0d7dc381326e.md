...
@(Info)()(If you want to know how to process carts of registered users, see [Managing Guest Carts](https://documentation.spryker.com/v1/docs/managing-guest-carts).)

## Guest Carts and Carts of Registered Users
Access to carts of registered users is provided by the /carts resource. Before accessing the resource, you need to authenticate a user first. For more details, see [Authentication and Authorization](https://documentation.spryker.com/v1/docs/authentication-and-authorization).
...
@(Error)()(To use this endpoint, you need to authenticate first. For details, see [Authentication and Authorization](https://documentation.spryker.com/v1/docs/authentication-and-authorization).)
...
@(Error)()(To use the endpoints, you need to authenticate first. For details, see [Authentication and Authorization](https://documentation.spryker.com/v1/docs/authentication-and-authorization).)
