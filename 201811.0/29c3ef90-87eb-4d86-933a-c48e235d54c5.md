...
2. On the **Create Company Unit Address** page:
    ...
    * Enter the City, Zip Code, and Street values to complete the address. Number, Addition to address, Comment, and Labels fields are optional. See [Company Account: Reference Information](https://documentation.spryker.com/v1/docs/company-account-reference-information) to know more about the attributes you select and enter.
...
***
**What's next?**
To know more about the attributes you select and enter on the **Create** and **Edit Company Unit Address** pages, see [Company Account: Reference Information](https://documentation.spryker.com/v1/docs/company-account-reference-information).
The next step in the company account setup is to created company roles and users. See the [Managing Company Roles](https://documentation.spryker.com/v1/docs/managing-company-roles) and [Managing Company Users](https://documentation.spryker.com/v1/docs/managing-company-users) articles.