...
Configure RabbitMQ permissions and virtual hosts according to the instructions [Tutorial - Set Up a "Hello World" Queue - Legacy Demoshop](https://documentation.spryker.com/v4/docs/setup-hello-world-queue#rabbitmq-management-ui).
