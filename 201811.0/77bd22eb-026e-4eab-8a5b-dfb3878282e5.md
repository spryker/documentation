...
@(Info)()(This is how a Spryker Admin interacts with other departments to make sure that the tax-based regulations are met.)
***
## Tax Rates and Sets
...
To know more about the attributes you use to manage tax rates and sets, see [Taxes: Reference Information](https://documentation.spryker.com/v1/docs/taxes-reference-information).