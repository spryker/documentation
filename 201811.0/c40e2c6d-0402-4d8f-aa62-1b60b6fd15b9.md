...
2. On the **Create Tax Rate** page, enter and select the attributes. See [Taxes: Reference information](https://documentation.spryker.com/v1/docs/taxes-reference-information) for more details.
3. Click **Save**.
***
### Editing a Tax Rate
...
2. On the **Edit Tax Rate** page, change the attributes. See [Taxes: Reference information](https://documentation.spryker.com/v1/docs/taxes-reference-information) for more details.
3. Click **Save**.
***
**Tips & Tricks**
...
2. On the **Create Tax Set** page, enter the tax set name and select one or several tax rates to assign. See [Taxes: Reference information](https://documentation.spryker.com/v1/docs/taxes-reference-information) for more details.
3. Click **Save**.
***
### Editing a Tax Set
In case you need to change the tax set: 
1. In the **List of tax sets > Actions** column, click **Edit** for a specific tax set.
2. On the **Edit Tax Set** page, change the attributes. See [Taxes: Reference information](https://documentation.spryker.com/v1/docs/taxes-reference-information) for more details.
3. Click **Save**.
