...
**Verification**
@(Info)()(Make sure the following endpoints are available:)
* `http://glue.mysprykershop.com/catalog-search?q={{q_term}}`
* `http://glue.mysprykershop.com/catalog-search-suggestions?q={{q_term}}`
@(Info)()(Make a request to `http://glue.mysprykershop.com/catalog-search?q={{q_term}}&include=abstract-products`. Make sure the response includes relationships to `abstract-products` resources.)

@(Info)()(Make a request to `http://glue.mysprykershop.com/catalog-search-suggestions?q={{q_term}}&include=abstract-products`. Make sure the response includes relationships to `abstract-products` resources.)
