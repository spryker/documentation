...
Review [Product Lists: Reference Information](https://documentation.spryker.com/v1/docs/product-lists-reference-information) to learn about the attributes you see, select, and enter while managing a product list.