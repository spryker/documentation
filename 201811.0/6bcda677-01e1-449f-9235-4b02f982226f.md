...
For more details on how Publish & Sync works, see [Publish and Synchronization ](https://documentation.spryker.com/v1/docs/publish-and-synchronization).
...
* If you would like to know more about the application layers and how various functionality is encapsulated in modules, see [Modularity and Shop Suite](https://documentation.spryker.com/v1/docs/modularity-and-shop-suite).
* If you want to know more about the building blocks of Spryker, see [Programming Concepts](https://documentation.spryker.com/v1/docs/programming-concepts).