...
* To find out how data flows are separated in Spryker Commerce OS, refer to [Commerce OS and Frontend Apps](https://documentation.spryker.com/v1/docs/commerce-os-and-frontend-apps).
