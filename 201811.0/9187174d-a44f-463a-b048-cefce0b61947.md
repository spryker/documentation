...
* To know how the navigation elements are managed, see [Managing Navigation](https://documentation.spryker.com/v1/docs/managing-navigation).
* To know more about the Navigation node types, see [Navigation Node Types](https://documentation.spryker.com/v1/docs/navigation-node-types) in the References section.
