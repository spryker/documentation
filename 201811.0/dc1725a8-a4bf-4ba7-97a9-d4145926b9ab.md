...
| --- | --- |
| [Gift Cards Purchase and Redeeming](https://documentation.spryker.com/v1/docs/gift-cards-purchase-redeeming) | Create a Gift Card |
| [Enable Gift Cards](https://documentation.spryker.com/v1/docs/enabling-gift-cards) | Find orders which are paid by Gift Cards |
