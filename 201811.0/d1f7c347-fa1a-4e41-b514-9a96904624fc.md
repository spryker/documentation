...
* To learn how the product labels are managed, see [Managing Product Labels](https://documentation.spryker.com/v1/docs/managing-product-labels). 
* To learn how you can prioritize the labels, see [Prioritizing Labels](https://documentation.spryker.com/v1/docs/prioritizing-labels).
* To learn more about the attributes you select and enter while creating or managing the labels or see some examples of product labels, see the [References](https://documentation.spryker.com/v1/docs/product-labels-reference-information) section.