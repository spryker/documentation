...
@(Error)(Important)(Once the company is created, one business unit for it is created by default. This is considered to be headquarters and can be managed in the same ways as the other business units. See [Managing Company Units](https://documentation.spryker.com/v1/docs/managing-company-units) for more details.)
***
...
***
**What's next?**
The company record is added and now you can proceed with creating a company unit. See [Managing Company Units](https://documentation.spryker.com/v1/docs/managing-company-units) for more details.