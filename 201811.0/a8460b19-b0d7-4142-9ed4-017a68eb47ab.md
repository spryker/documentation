...
@(Info)()(For more details, see [Glue Infrastructure](https://documentation.spryker.com/v1/docs/glue-infrastructure).)
...
@(Info)()(For more details, see [REST API Reference](https://documentation.spryker.com/v1/docs/rest-api-reference).)
...
@(Info)()([Install and run!](https://documentation.spryker.com/v1/docs/b2c-api-react-example))
