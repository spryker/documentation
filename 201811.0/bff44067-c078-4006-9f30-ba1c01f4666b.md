...
@(Warning)(Authentication)(To use this endpoint, customers need to authenticate first. For details, see [Authentication and Authorization](https://documentation.spryker.com/v1/docs/authentication-and-authorization).)
...
@(Info)(Modifying Customer Addresses )(You need to use specialized endpoints to retrieve and manage addresses registered for a customer. For details, see [Managing the List of Customer Addresses](https://documentation.spryker.com/v1/docs/managing-customers-api#managing-the-list-of-customer-addresses).)
...
@(Warning)(Authentication )(Only authenticated users can manage customer addresses. For details on how to authenticate a customer, see [Authentication and Authorization](https://documentation.spryker.com/v1/docs/authentication-and-authorization).)
