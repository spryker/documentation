    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v4/docs/shopping-lists-feature-integration" class="mr-link">Enable the Shopping list feature in your project</a></li>
                <li><a href="https://documentation.spryker.com/v4/docs/shopping-list-note" class="mr-link">Module Guide: ShoppingListNote</a></li>
                <li><a href="https://documentation.spryker.com/v4/docs/shopping-list-note-widget" class="mr-link">Module Guide: ShoppingListNoteWidget</a></li>
            </ul>
        </div>
        <!-- col3 -->
        <div class="mr-col">
