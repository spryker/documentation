...
***
**Tips & Tricks**
To know more about the node types that you select, see [Navigation Node Types](https://documentation.spryker.com/v1/docs/navigation-node-types) in the References section.