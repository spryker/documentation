...
The conditions are created in the form of a query and may be entered as a plain query or via the query builder. (See [Discount Calculation: Reference Information](https://documentation.spryker.com/v1/docs/discount-calculation-reference-information) for more details.)
