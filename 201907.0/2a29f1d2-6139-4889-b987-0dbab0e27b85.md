...
2. Create validation configuration:
    ...
    b. In the file, describe validation rules for endpoints. See see [Validating REST Request Format](https://documentation.spryker.com/v3/docs/validating-rest-request-format) for more details. Example:
