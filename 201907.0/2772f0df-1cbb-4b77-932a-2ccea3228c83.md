    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/v3/docs/shopping-list-note" class="mr-link">Module Guide: ShoppingListNote</a></li>
                <li><a href="https://documentation.spryker.com/v3/docs/shopping-list-note-widget" class="mr-link">Module Guide: ShoppingListNoteWidget</a></li>
            </ul>
        </div>
        <!-- col3 -->
        <div class="mr-col">
