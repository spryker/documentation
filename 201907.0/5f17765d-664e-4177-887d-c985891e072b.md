...
| --- | --- |
| Search API | [Catalog Search](https://documentation.spryker.com/docs/catalog-search)<br>[Getting Suggestions for Auto-Completion and Search](https://documentation.spryker.com/docs/getting-suggestions-for-autocompletion-and-search) |
| Category API | [Browsing a Category Tree](https://documentation.spryker.com/docs/browsing-category-tree) |
