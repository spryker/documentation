...
1. Update `spryker/quote-request-agent` to version ^2.0.0 by following the steps from [Migration Guide - QuoteRequest](https://documentation.spryker.com/v4/docs/mg-quoterequest).
2. Update `spryker/quote-request` to version ^2.0.0 by following the steps from [Migration Guide - Quote Request Agent](https://documentation.spryker.com/v4/docs/mg-quoterequestagent).
