...
***
**Prerequisites**
Once you decide to add a new shipment method, please make sure that you have a carrier company to assign a shipment method. If you don't have an appropriate carrier, see  [Creating a Carrier Company](https://documentation.spryker.com/v3/docs/creating-a-carrier-company). You also need to make sure that you have an appropriate tax set in the **Taxes > Tax Sets** section, see [Taxes](https://documentation.spryker.com/v3/docs/taxes).
***
