...
* [Checking for newer versions](https://documentation.spryker.com/v3/docs/composer)
* [Release notes](https://documentation.spryker.com/v3/docs/release-notes)
* [Migration guides](https://documentation.spryker.com/v3/docs/about-migration)