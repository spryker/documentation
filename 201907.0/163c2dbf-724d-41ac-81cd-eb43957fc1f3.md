...
To learn more about the differences in the access levels, check [Shared Carts Feature Overview](https://documentation.spryker.com/v3/docs/shared-cart-overview).