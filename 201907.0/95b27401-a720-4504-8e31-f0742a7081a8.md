Besides setting [global and merchant relation thresholds](https://documentation.spryker.com/v2/docs/threshold)  for minimum order values manually in the Back Office, they can also be imported in bulk from a .csv file.
