...
***
**What's next?**
To learn about the attributes that you select and enter while managing product relations, see [Product Relations: Reference Information](https://documentation.spryker.com/v4/docs/product-relations-reference-information).