...
<br>
 ...
 @(Warning)(Verification)(To verify that `AvailabilityNotificationSubscriber` is working:<ol><li>add a new product and make it unavailable;</li><li>on Yves, as a customer, subscribe to its availability notifications;</li><li>make the product available;</li><li>check your mailbox for the email about the product's availability.</li></ol>)
