...
2. On the **Create Transferred Cart Connection** page, enter and select the attributes. See [Punch Out: Reference Information](https://documentation.spryker.com/v3/docs/punch-out-reference-information).
3. Click **Create**.
...
2. On the **Edit Transferred Cart Connection** page, change the attributes. See [Punch Out: Reference Information](https://documentation.spryker.com/v3/docs/punch-out-reference-information).
3. Click **Save**.
