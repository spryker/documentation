...
@(Warning)()(To be able to search for products, make sure that [Search Widget for Concrete Products](https://documentation.spryker.com/v2/docs/search-widget-for-concrete-products-overview-201903) feature is [integrated](https://documentation.spryker.com/v3/docs/shopping-lists-shop-guide) into your project.)
...
* Add a note to the item. To save the note, click **Save**. See [Shopping List Notes Feature Overview](https://documentation.spryker.com/v3/docs/shopping-list-notes-overview) for more details.
...
The shopping list with the available items will be added to the shopping cart. See [Shopping Cart](https://documentation.spryker.com/v4/docs/shop-guide-managing-shopping-carts) to learn how to manage and purchase items using the cart.
