...
The next step is to add a new shipment method to it. See [Creating and Managing Shipment Methods](https://documentation.spryker.com/v3/docs/creating-and-managing-shipment-methods) for more details.