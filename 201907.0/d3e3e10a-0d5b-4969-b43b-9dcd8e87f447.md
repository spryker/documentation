...
@(Info)()(Only [abstract](https://documentation.spryker.com/v3/docs/product-abstraction#differentiate-between-abstract-and-concrete-products) products support Product Relations. For more details, see [Product Relations](https://documentation.spryker.com/v3/docs/product-relations).)
