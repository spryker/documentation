...
See [Publish and Synchronization](https://documentation.spryker.com/v3/docs/publish-and-synchronization) to find out more about how the Publish and Synchronization works and how to extend it.
