...
3. Make changes to the needed attributes. See [Content Items: Reference Information](https://documentation.spryker.com/v4/docs/content-items-reference-information) to learn more about content item attributes. 
