...
* GLUE layer has been moved from Glue `OauthCompanyUser` to `CompanyUserAuthRestApi` (see [Migration Guide - CompanyUserAuthRestApi](https://documentation.spryker.com/v4/docs/companyuserauthrestapi-migration-guide) for more details).
