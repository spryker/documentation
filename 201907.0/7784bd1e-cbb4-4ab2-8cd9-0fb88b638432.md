...
**[User Guides](https://documentation.spryker.com/v3/docs/about-user-guides)**: Meant primarily for the end-users who need assistance navigating and using features of the Spryker Back Office and Storefront.
...
**[Migration and Integration](https://documentation.spryker.com/v3/docs/about-migration-integration)**: Holds feature integration and module migration guides for the developers.
