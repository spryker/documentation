...
The main advantage is that you do not need to make any manual calculations. The system does all the calculations automatically and you get the aggregated availability value. You will have a single table with  a comparison of the product's stock value and the ordered value. It also calculates the bundled products stock. See [Availability: Reference Information](https://documentation.spryker.com/v4/docs/availability-reference-information).
***
...
This will take you to the **Product Availability** page. See [Availability: Reference Information](https://documentation.spryker.com/v4/docs/availability-reference-information) for more details.
...
@(Warning)(Note)(Please note that you are updating the product variant availability, not the bundle availability itself. To see examples on how the bundle availability is calculated, see [Availability: Reference Information](https://documentation.spryker.com/v4/docs/availability-reference-information).)
***
**Tips & Tricks**
