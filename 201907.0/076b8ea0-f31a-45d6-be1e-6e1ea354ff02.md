...
@(Info)()(For more details, check [Cart Data Flow](https://documentation.spryker.com/v4/docs/cart-functionality#cart-data-flow) in the *Cart Functionality* section.)
...
@(Info)(Discount Calculation)(Discount calculation is a separate topic and is explained in the [Discount](https://documentation.spryker.com/v3/docs/discount-feature-overview-201903#calculation) article.)
