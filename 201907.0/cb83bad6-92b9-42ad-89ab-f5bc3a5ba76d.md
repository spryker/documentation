...
* through a [shopping list widget](https://documentation.spryker.com/v3/docs/shopping-list-widget) in the header of the shop
...
The detailed information on managing shopping lists is covered in the [Shop User Guide](https://documentation.spryker.com/v3/docs/shopping-lists-shop-guide).
...
* Product attribute
* Product options
* Product comments (see [Shopping List Notes](https://documentation.spryker.com/v3/docs/shopping-list-notes) for more details)
* Quantity
* Item price
* Availability
...
3. **Printing shopping list**: See [Printing Shopping list](https://documentation.spryker.com/v3/docs/printing-shopping-list) to learn how it works
...
3. **Printing shopping list**: See [Printing a Shopping List](https://documentation.spryker.com/v3/docs/printing-shopping-list) to learn how it works
