...
* [Invoice](https://documentation.spryker.com/v4/docs/ratepay-invoice)
* [Prepayment](https://documentation.spryker.com/v4/docs/ratepay-prepayment)
* [Direct Debit (ELV)](https://documentation.spryker.com/v4/docs/ratepay-direct-debit)
* [Installment](https://documentation.spryker.com/v4/docs/ratepay-installment)
