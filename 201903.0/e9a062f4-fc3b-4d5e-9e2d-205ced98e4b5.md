...
See [Products: Reference Information](https://documentation.spryker.com/v2/docs/products-reference-information) to know more about abstract products and concrete products.
...
So first you create an abstract product. See the [Creating an Abstract Product](https://documentation.spryker.com/v2/docs/creating-an-abstract-product) article.