...
The next step is to add a new shipment method to it. See the [Creating and Managing Shipment Methods](https://documentation.spryker.com/v2/docs/creating-and-managing-shipment-methods) article.