...
2. On the **Add Product Relations** page > **Relation Type** tab:
    ...
    2. In the **Relation type** drop-down, select the type (Related products or Upselling). See [Product Relations: Reference Information](https://documentation.spryker.com/v4/docs/product-relations-reference-information) to know more about the product relation types and see some examples of how those types are used.
...
4. On the **Assign products** tab, in the **Assign related products** section:
    1. Click **Add rule** or **Add group**, depending on the conditions you want to specify. See [Product Relations: Reference Information](https://documentation.spryker.com/v4/docs/product-relations-reference-information) to know more about rules and groups.
...
* To know how the product relations can be managed, see the [Managing Product Relations](https://documentation.spryker.com/v4/docs/managing-product-relations) article.
* To know more about the attributes you select and enter while creating a product relation, see [Product Relations: Reference Information](https://documentation.spryker.com/v4/docs/product-relations-reference-information).