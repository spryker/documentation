...
@(Info)()(For more details, see [Glue Infrastructure](https://documentation.spryker.com/v2/docs/glue-infrastructure).)
...
@(Info)()(For more details, see [REST API Reference](https://documentation.spryker.com/v2/docs/rest-api-reference).)
...
@(Info)()([Install and run!](https://documentation.spryker.com/v2/docs/b2c-api-react-example))
