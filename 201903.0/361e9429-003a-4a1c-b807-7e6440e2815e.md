...
@(Info)()(For more details on managing navigation trees, see [Navigation](https://documentation.spryker.com/v4/docs/navigation).)

## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Navigation](https://documentation.spryker.com/v3/docs/navigation-api-feature-integration-1).
