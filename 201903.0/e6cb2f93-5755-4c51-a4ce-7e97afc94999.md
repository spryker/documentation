...
@(Info)()(Only [abstract](https://documentation.spryker.com/v2/docs/product-abstraction#differentiate-between-abstract-and-concrete-products) products support Product Relations. For more details, see [Product Relations](https://documentation.spryker.com/v2/docs/product-relations).)
...
@(Info)()(To be able to use **Product Relations API**, first, you need to have the Product Relations feature integrated with your project. For details, see [Product Relation Integration](https://documentation.spryker.com/v4/docs/product-relation-integration).)
...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [Product Relations API Feature Integration](https://documentation.spryker.com/v2/docs/product-relations-api-feature-integration-201903).
...
@(Info)()(For details on peculiarities of managing carts of registered users, see [Managing Carts of Registered Users](https://documentation.spryker.com/v4/docs/managing-carts-of-registered-users-201907).)
...
@(Info)()(For details on how to retrieve and manage the identifier, see [Managing Guest Carts](https://documentation.spryker.com/v4/docs/managing-guest-carts).)
