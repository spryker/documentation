...
@(Info)(Veriication)(Make sure that the following module is installed:)
...
@(Info)(Verification)(Make a request to `http://example.org/abstract-products/{{abstract_sku}}?include=category-nodes.`)
<details open>
