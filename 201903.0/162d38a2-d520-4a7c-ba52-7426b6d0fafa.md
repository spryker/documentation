...
* [Checking for newer versions](https://documentation.spryker.com/v2/docs/composer)
* [Release notes](https://documentation.spryker.com/v2/docs/release-notes)
* [Migration guides](https://documentation.spryker.com/v2/docs/about-migration)