...
@(Warning)()(If you have not installed plugins needed for Merchant and Merchant Relations<!-- add a link (http://documentation.spryker.com/capabilities/company_account/merchants_and_merchant_relations/merchants-and-merchant-relations.htm)-->, add them here as well. See _Merchant and Merchant Relations feature integration guide_ <!-- link to IG--> for more details.)
...
@(Info)()(See  _Migration Guide - PriceProduct_<!--(https://documentation.spryker.com/module_migration_guides/mg-priceproduct.htm)--> for information on how to migrate to a newer version of the `PriceProduct` module with price dimensions support.)