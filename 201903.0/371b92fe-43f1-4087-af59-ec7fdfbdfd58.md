...
We’ll display a random salutation message that is retrieved from Zed. Follow the steps in [Tutorial - Adding a New Module](https://documentation.spryker.com/v2/docs/t-add-new-bundle) to have the backend implementation ready.
