...
* through a [shopping list widget](https://documentation.spryker.com/v2/docs/shopping-list-widget) in the header of site
...
* Creation date
* Possible actions to manage shopping lists: [edit](#edit), [print](https://documentation.spryker.com/v2/docs/printing-shopping-list), [delete](#deleted), [share](#share), [dismiss](#dismiss) (for shared shopping lists)
...
* Add comments to items (check [Shopping list notes](https://documentation.spryker.com/v2/docs/shopping-list-notes) for more details)
...
* Product attribute
* Product options 
* Product comments (see [Shopping List Notes](https://documentation.spryker.com/v2/docs/shopping-list-notes) for more details)
* Quantity
* Item price
* Availability
...
3. **Printing shopping list**: Check [Printing Shopping list](https://documentation.spryker.com/v2/docs/printing-shopping-list) to learn how it works
...
1. **Reading Shopping list**: On the *Shopping List View* page, the user sees the name of owner, access level (*Full access*), number of users the shopping list is shared with, as well as table of items with the following information:
  ...
  - Product attribute
  - Product options 
  - Product notes (see [Shopping List Notes](https://documentation.spryker.com/v2/docs/shopping-list-notes) for more details)
  - Quantity
  - Item price
  - Availability
...
3. **Printing shopping list**: See [Printing a Shopping List](https://documentation.spryker.com/v2/docs/printing-shopping-list) to learn how it works
