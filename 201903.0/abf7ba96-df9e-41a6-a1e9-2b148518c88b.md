...
A Page module typically contains a `ControllerProvider` plugin for routing (see [URL Routing](https://documentation.spryker.com/v2/docs/yves-url-routing)) and some Controllers with their twig templates (see [Controllers and Actions](https://documentation.spryker.com/v2/docs/controllers-actions)). The implementation scope of a *Page* module should be decided individually, depending on its need of re-usability. 
