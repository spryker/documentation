...
The modules combine to create [features](https://documentation.spryker.com/v2/docs/about-features) and have limited dependencies. The limited dependencies imply less development effort, increasing your return on investment and lowering the total cost of ownership.
...
* [What's new](https://documentation.spryker.com/v2/docs/whats-new): general information about Spryker, news, and release notes.
* [Spryker Installation Guides](https://documentation.spryker.com/v2/docs/about-installation): to install Spryker.
* [Features](https://documentation.spryker.com/v2/docs/about-features): to learn about the Spryker features.
* [Glue REST API](https://documentation.spryker.com/v2/docs/glue-rest-api): for the Spryker Glue REST API overview, reference, and features.
* [User Guides](https://documentation.spryker.com/v2/docs/about-user-guides): step-by-step Backoffice and Storefront user guides.
* [Developer Guides](https://documentation.spryker.com/v2/docs/about-developer-guides): technical information and guides for developers. 
...
* [Migration and Integration Guides](https://documentation.spryker.com/v2/docs/about-migration-integration): instructions on how to migrate to newer versions of modules or features.
* [Tutorials](https://documentation.spryker.com/v2/docs/about-tutorials): for tutorials and HowTos.