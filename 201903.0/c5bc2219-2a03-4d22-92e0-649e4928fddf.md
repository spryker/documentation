...
The Back Office is provided to allow assigning stocks to products. See [Availability](https://documentation.spryker.com/v3/docs/managing-products-availability) for details on how to manage product stocks in the Back Office.
