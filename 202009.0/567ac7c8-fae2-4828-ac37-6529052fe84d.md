...
2.  Create `spy_hello_spryker_message` table in database:
...
*   [Publish & Synchronization Introduction](https://spryker.atlassian.net/wiki/spaces/DOCS/pages/193101896/Publish+Synchronize+CORE-1073+AC-32+WORK+IN+PROGRESS)
    
*   [How To's](https://spryker.atlassian.net/wiki/spaces/DOCS/pages/198934821/How+To+Implement+Publish+and+Synchronize+in+Your+Code)
    
*   [FAQ](https://spryker.atlassian.net/wiki/spaces/DOCS/pages/61145106/Publish+and+Synchronization+FAQ)
