This document describes how to use and extend themes. 
...
Extend Twig on the project level as follows:
...
Extend Twig on the core level as follows:
...
Extend SCSS on the project level as follows:
...
Extend SCSS on the core level as follows:
