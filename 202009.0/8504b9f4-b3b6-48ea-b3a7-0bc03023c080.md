...
To retrieve all wishlists of a user, send the request:
...
| Path parameter | Description |
| --- | --- |
| ***{{wishlist_id}}*** | Unique identifier of the wishlist to add the items to. [Create a wishlist](#create-a-wishlist) or [retrieve all wishlists](#retrieve-wishlists) to get it. |
...
| Path parameter | Description |
| --- | --- |
| ***{{wishlist_id}}*** | Unique identifier of the wishlist to delete an item from. [Create a wishlist](#create-a-wishlist) or [retrieve all wishlists](#retrieve-wishlists) to get it. |
