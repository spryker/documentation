...
In Spryker Commerce OS, token generation is performed using a facade method, that is why no GUI is present. To generate a token, see [HowTo - Generate a Token for Login](https://documentation.spryker.com/docs/ht-generating-token-for-login-201907).
