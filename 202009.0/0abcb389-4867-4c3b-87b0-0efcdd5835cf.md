    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/docs/product-reviews" class="mr-link">Get a general idea of the Ratiings and reviews feature</a></li>
                <li><a href="https://documentation.spryker.com/docs/product-review-feature-integration" class="mr-link">Integrate the Rating and reviews feature into your project</a></li>
            </ul>
        </div>
      <!-- col2 -->
        <div class="mr-col">
