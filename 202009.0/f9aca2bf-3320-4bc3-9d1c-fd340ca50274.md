...
* http://glue.mysprykershop.com/shopping-lists/{{shopping_list_uuid}}?include=shopping-list-items,concrete-products

Check the response:
<details open>
<summary>GET http://glue.mysprykershop.com/shopping-lists/{{shopping_list_uuid}}?include=shopping-list-items,concrete-products</summary>
...
* http://glue.mysprykershop.com/shopping-lists/{{shopping_list_uuid}}/shopping-list-items
...
Check the response:
<details open>
<summary>POST http://glue.mysprykershop.com/shopping-lists/{{shopping_list_uuid}}/shopping-list-items</summary>
