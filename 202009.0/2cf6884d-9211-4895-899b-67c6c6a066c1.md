...
@(Warning)()(You can use any module name instead of `->glossary()`. The structure is always the same, so you can copy and adapt it for your use case.)
...
@(Warning)()(This is not needed in the project code and we recommend avoiding it to reduce overhead.)
