...
| --- | --- | --- | --- |
| customer | RestCustomerTransfer | x | Information about the customer.</br>For details, see [Managing Customers](https://documentation.spryker.com/docs/en/customers){target="_blank"}. |
...
| billingAddress | RestAddressTransfer | x | Customer's billing address.</br>For details, see [Managing Customers](https://documentation.spryker.com/docs/en/customers){target="_blank"}. |
...
| --- | --- |
| addresses | An array of customer addresses that can be used for billing and shipping.</br>For details, see [Managing Customers](https://documentation.spryker.com/docs/en/customers){target="_blank"}.  |
...
| Attribute | Type | Required | Description |
| --- | --- | --- | --- |
| customer | RestCustomerTransfer | v | Information about the customer.</br>For details, see [Managing Customers](https://documentation.spryker.com/docs/en/customers){target="_blank"}. |
...
| billingAddress | RestAddressTransfer | v | Customer's billing address.</br>For details, see [Managing Customers](https://documentation.spryker.com/docs/en/customers){target="_blank"}. |
| shippingAddress | RestAddressesRequestData | v | Customer's shipping address.</br>For details, see [Managing Customers](https://documentation.spryker.com/docs/en/customers){target="_blank"}. |
