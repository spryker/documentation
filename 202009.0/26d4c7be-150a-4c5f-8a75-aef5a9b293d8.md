This endpoint allows to finilaze the checkout process by placing an order. 
...
@(Warning)(Cart deletion)(By default, if a checkout is successful, the order is placed, and the cart is deleted automatically.)
...
| paymentMethodName | String | | Name of the payment method for this order. |
| paymentProviderName | String | | Name of the payment provider for this order. | 
| shipment | Object |  | A list of attributes describing the shipping method selected for this order. |
| idShipmentMethod | String |  | Unique identifier of the shipment method for this order. |
