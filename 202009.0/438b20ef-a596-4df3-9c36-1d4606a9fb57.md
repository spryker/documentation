    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/docs/en/retrieving-company-user-information-201907" class="mr-link">Retrieve information about company user via Glue API</a></li>
              </ul>
        </div>
        <!-- col2 -->
        <div class="mr-col">
