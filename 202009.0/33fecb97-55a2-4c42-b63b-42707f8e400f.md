The rule of thumb for your tests should be:
...
It is advised to organize your tests as well. For s simpler test setup, you should at least add your own LocatorHelper, which is enabled in your project namespace by default.
