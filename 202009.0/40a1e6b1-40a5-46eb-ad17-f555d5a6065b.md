By default CMS module doesn't specify the content field size. Based on your DB (MySql, MariaDB, or PostgreSql), it will be transferred to TEXT (65535 bytes) for MySQL and MariaDB, and TEXT (unlimited length) for PostgreSQL.
