...
| --- | --- |
| ***{{customer_id}}*** | Unique identifier of the customer to add the address to. [Create a customer](https://documentation.spryker.com/docs/customers#create-a-customer) to get this id. |


### Request

Request sample: `POST http://glue.mysprykershop.com/customers/DE-25/addresses`
...
## Retrieve a list of customer's addresses
