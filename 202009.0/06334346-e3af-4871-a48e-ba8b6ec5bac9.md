...
@(Warning)(Verification)(Make sure that the availability subscription form is present on the *product details* page. To do this, find a concrete product that is out of stock and visit its product details page.)