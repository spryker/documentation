...
```bash
composer update spryker/cart-page spryker/customer-page spryker/customer-reorder-widget spryker/discount-promotion-widget spryker/product-detail-page spryker/product-set-widget
```
