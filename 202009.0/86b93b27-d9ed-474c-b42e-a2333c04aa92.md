...
## Retrieve a abstract product list content item

To retrieve an abstract product list content item, send the request:

***
`GET` **content-product-abstract-lists/*{{content_item_key}}*/content-product-abstract**
***
...
| Request | Usage |
| --- | --- |
| GET https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract | --- |
| GET https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract?include=abstract-product-availabilities | --- |
| GET https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract?include=abstract-product-image-sets | --- |
| GET https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract?include=abstract-product-prices | --- |
| GET https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract?include=category-nodes | --- |
| GET https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract?include=product-tax-sets | --- |
| GET https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract?include=product-labels | --- |
| GET https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract?fields[abstract-products]=sku,name,description | --- |
| --- | --- |
| --- | --- |
| --- | --- |
...
```json
{
	...
	"links": {
		"self": "https://glue.mysprykershop.com/content-product-abstract-lists/apl-1/content-product-abstract?fields[abstract-products]=sku,name,description&include=abstract-product-prices"
	}
}
```
