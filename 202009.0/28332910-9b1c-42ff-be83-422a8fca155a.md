...
|**NPM**| Version 6.9.0 |
|**Intranet**| Backoffice Application (Zed) must be secured in an Intranet (using VPN, Basic Auth, IP Allowlist, DMZ, or other practices) |



### Supported browsers
The Spryker Commerce OS supports the following browsers for all frontend-related projects/products ([B2B Demo Shop](https://documentation.spryker.com/docs/demoshops#b2b-demo-shop), [B2C Demo Shop](https://documentation.spryker.com/docs/demoshops#b2c-demo-shop), [Master Suite](https://documentation.spryker.com/docs/demoshops#master-suite)):
