...
1. Discounts applied to carts based on certain conditions, called [cart rules](https://documentation.spryker.com/v4/docs/creating-a-cart-rule-discount);
2. Price reductions provided when redeeming a [discount voucher](https://documentation.spryker.com/v4/docs/creating-a-discount-voucher).
...
## Installation
For detailed information on the modules that provide the API functionality and related installation instructions, see [GLUE: Promotions & Discounts Feature Integration](https://documentation.spryker.com/v4/docs/glue-promotions-discounts-feature-integration).

## Applying Discount Vouchers
To apply a discount voucher, first, a customer needs to have a cart with some products in it.

:::(Info) (Info)
For details on how to manage carts, see [Managing Carts](https://documentation.spryker.com/v4/docs/managing-carts).
:::
