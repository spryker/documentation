To be aware of what you are testing, you should know the code coverage. To get the code coverage report generated, you need to have Xdebug enabled and run your tests with an additional flag:
