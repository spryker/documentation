...
* [Creating Product Attributes](https://documentation.spryker.com/v4/docs/creating-a-product-attribute)
* [Managing Product Attributes](https://documentation.spryker.com/v4/docs/managing-attributes)

To know more about the fields you enter and select when working with attributes, see the [References](https://documentation.spryker.com/v4/docs/attributes-reference-information) section.