...
**Documentation**: [Checking Out Purchases and Getting Checkout Data](https://documentation.spryker.com/v2/docs/checking-out-purchases-and-getting-checkout-data).
