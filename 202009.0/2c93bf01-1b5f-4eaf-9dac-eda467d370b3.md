...
```bash
composer require spryker-feature/order-threshold:"^master" --update-with-dependencies
```
...
### 3) Add Translations
@(Info)(Info)(All threshold messages need to have glossary entities for the configured locales.)
...
**vendor/spryker/sales-order-threshold-data-import/data/import/sales_order_threshold.cs**v
