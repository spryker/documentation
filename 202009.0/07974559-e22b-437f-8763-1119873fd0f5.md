...
## Prerequisites
The data in the queue to consume messages from. If you do not have data in the `PRODUCT_ABSTRACT_QUEUE`, see [Importing data with the queue data importer](https://documentation.spryker.com/docs/importing-data-with-queue-data-importer#exporing-data-from-csv-to-queue).
