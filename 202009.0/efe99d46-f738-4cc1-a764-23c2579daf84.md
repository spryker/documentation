...
* from Shopping Lists page in My Account menu. See [Creating a shopping list](https://documentation.spryker.com/docs/shopping-lists-shop-guide#create-shopping-list) for more detailed instruction.
...
3. **Printing shopping list**: See [Printing Shopping list](https://documentation.spryker.com/docs/printing-shopping-list) to learn how it works
