...
In the above example output you can see that Spryker prints some meta information `Store: DE | Environment: development`. You can disable this output with the option `--quiet-meta`. This is very usefull when you want to output, for example, JSON.
