...
In the above example output you can see that Spryker prints some meta informations `Store: DE | Environment: development` this output can be disabled with the option `--quiet-meta`. This is very usefull when you want to output e.g. json.
