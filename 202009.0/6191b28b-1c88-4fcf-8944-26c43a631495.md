...
| POST https://glue.mysprykershop.com/checkout-data?include=addresses | Submit checkout data and include the logged-in customer's addresses into the response. |
| POST https://glue.mysprykershop.com/checkout-data?include=company-business-unit-addresses | Submit checkout data and include the logged-in company users's company business unit addresses into the response. |
...
| addresses | country | String | Country. Currently, the endpoint returns this attribute as an object. We know about this issue and will fix it in future. |
