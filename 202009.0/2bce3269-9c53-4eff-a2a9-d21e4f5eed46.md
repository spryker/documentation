...
@(Info)()(If the [Prices per Merchant Relation \(Customer specific prices\)](https://documentation.spryker.com/docs/price-per-merchant-relation) feature is enabled in your project, all prices returned by Glue API are specific to the company of the current company user.)
