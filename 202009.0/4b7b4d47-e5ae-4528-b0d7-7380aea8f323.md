...
To enable this change, please adjust `\Pyz\Zed\Calculation\CalculationDependencyProvider::getQuoteCalculatorPluginStack` according to [Calculation Migration Guide](https://documentation.spryker.com/v4/docs/mg-calculation). Place `InitialGrandTotalCalculatorPlugin()` in the right sequence.
...
* [Fact-Finder - Campaigns](https://documentation.spryker.com/v4/docs/search-factfinder-campaigns)
* [Fact-Finder - Recommendation](https://documentation.spryker.com/v4/docs/search-factfinder-recommendation)