...
* Have a discount rule for a product. Discount application type should be Promotional product (see [Creating a Cart Rule Discount](https://documentation.spryker.com/v5/docs/creating-a-cart-rule)).
...
* `POST http://glue.mysprykershop.com/carts/{{cart-uuid}}/items?include=items,cart-rules`
