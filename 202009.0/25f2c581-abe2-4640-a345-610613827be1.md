@(Error)()(The following Feature Integration guide expects the basic feature to be in place.</br>The current Feature Integration guide only adds the **Warehouse Management** and **Add to cart from catalog page** functionalities.)
