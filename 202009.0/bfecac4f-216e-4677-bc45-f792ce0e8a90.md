...
**Next steps**
* To set up an organization of your tests, see [Setting up Tests](https://documentation.spryker.com/docs/setting-up-tests).
* To create or enable a test helper, see [Test Helpers](https://documentation.spryker.com/docs/test-helpers).
* For information on the console commands you can use to execute your tests, see [Executing Tests](https://documentation.spryker.com/docs/executing-tests).
