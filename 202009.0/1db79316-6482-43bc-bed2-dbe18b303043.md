...
System requirement: In ordeer to protect application and user data, Backoffice Application (Zed) must be secured in an Intranet (using VPN, Basic Auth, IP Allowlist, DMZ or other practices).
