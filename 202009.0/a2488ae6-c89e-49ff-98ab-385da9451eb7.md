@(Info)()(This month we released some important [security updates](https://documentation.spryker.com/v4/docs/security-updates).)
...
For other related documentation, see [HowTo - Add New Shipment Method](https://documentation.spryker.com/v4/docs/ht-add-new-shipment-method-2)
...
* [Queue Integration - Loggly](https://documentation.spryker.com/v4/docs/loggly-queue)
* [Payolution — Configuration](https://documentation.spryker.com/v4/docs/payolution-configuration)
* [Payolution — Workflow](https://documentation.spryker.com/v4/docs/payolution-workflow)
