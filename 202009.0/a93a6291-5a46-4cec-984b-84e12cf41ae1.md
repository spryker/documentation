...
See  to learn how a Back Office User manages the content of email templates by editing Email CMS Blocks.

After creating email templates, a developer can import their assigned Email CMS Blocks. See [example of the import file](https://github.com/spryker-shop/suite/blob/master/data/import/common/common/cms_block.csv) with the Email CMS Blocks in Spryker Master Suite.

## Email Content

When editing an email template via Email CMS Block, you work in the [WYSIWYG editor](https://documentation.spryker.com/docs/wysiwyg-editor). Apart from the regular WYSIWYG editor tools, you can add glossary keys and variables.
