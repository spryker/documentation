...
* how to add a state machine, commands and conditions to the [Oms module](https://documentation.spryker.com/docs/oms-matrix)
* how to add CheckoutPlugins to the Payment module
* how to handle refunds with the [Refund module](https://documentation.spryker.com/docs/refund)
