...
`POST https://glue.mysprykershop.com/guest-cart-items?include=concrete-products,product-options`
...
<a name="create-a-guest-cart-response-attributes"></a>
...
| selectedProductOptions.optionGroupName | String | Specifies the name of the group to which the option belongs. |
| selectedProductOptions.sku | String | Specifies the SKU of the product option. |
| selectedProductOptions.optionName | String | Specifies the option name. |
| selectedProductOptions.price | Integer | Specifies the option price in cents. |
| selectedProductOptions.currencyIsoCode | String | Specifies the ISO 4217 code of the currency in which the product option price is specified. |
...
| STRING PARAMETER | DESCRIPTION | Possible values |
| --- | --- | --- |
| include | Adds resource relationships to the request. | <ul><li>guest-cart-items</li><li>cart-rules</li><li>promotional-items</li><li>gift-cards</li><li>vouchers</li><li>product-options</li></ul>|
...
```json
{
    "data": [
        {
            ...
            "links": {
                "self": "https://glue.69.demo-spryker.com:80/guest-carts/7e42298e-9f15-5105-a192-96726a2b9da8"
            },
            "relationships": {
                "guest-cart-items": {
                    "data": [
    ...
    "links": {
        "self": "https://glue.69.demo-spryker.com:80/guest-cart-items?include=guest-cart-items,concrete-products,product-options"
    },
    "included": [
        {
            "type": "product-options",
            ...
            "links": {
                "self": "https://glue.69.demo-spryker.com:80/concrete-products/181_31995510/product-options/OP_1_year_waranty"
            }
        },
        {
            "type": "product-options",
            ...
            "links": {
                "self": "https://glue.69.demo-spryker.com:80/concrete-products/181_31995510/product-options/OP_2_year_waranty"
            }
        },
        {
            "type": "product-options",
            ...
            "links": {
                "self": "https://glue.69.demo-spryker.com:80/concrete-products/181_31995510/product-options/OP_3_year_waranty"
            }
        },
        {
            "type": "product-options",
            ...
            "links": {
                "self": "https://glue.69.demo-spryker.com:80/concrete-products/181_31995510/product-options/OP_insurance"
            }
        },
        {
            "type": "product-options",
            ...
            "links": {
                "self": "https://glue.69.demo-spryker.com:80/concrete-products/181_31995510/product-options/OP_gift_wrapping"
            }
        },
        {
            "type": "concrete-products",
            ...
            "links": {
                "self": "https://glue.69.demo-spryker.com:80/concrete-products/181_31995510"
            },
            "relationships": {
                "product-options": {
                    "data": [
        ...
        },
        {
            ...
            "links": {
                "self": "https://glue.69.demo-spryker.com:80/guest-carts/7e42298e-9f15-5105-a192-96726a2b9da8/guest-cart-items/181_31995510-3-5"
            },
            "relationships": {
                "concrete-products": {
                    "data": [
...
For the attributes of guest cart items and product options, see [Create a guest cart](#create-a-guest-cart-response-attributes)
