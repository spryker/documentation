...
| --- | --- | --- |
| include | Adds resource relationships to the request. | <ul><li>concrete-products</li><li>sales-units</li><li>cart-rules</li><li>product-options</li></ul> |

:::(Info) (Included resources)
To retrieve product options, include both `concrete-products` and `product-options`.
:::
