...
1. First data must be located from original data source into the queues.
...
2. Data previously stored in a queue is consumed from the queue and imported into persistent storage. if you have already data in the queues please skip this part and check Queue Dataimport Tutorial. 
