...
| Status code | Reason |
| --- | --- |
| 400 | The provided access token is not an [access token of a Company User](https://documentation.spryker.com/docs/logging-in-as-company-user-201907). </br>**OR** </br> The shopping list ID is not specified. |
