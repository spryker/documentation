This endpoint allows completing a payment with payment verification of a third-party resource.
...
| dataPayload | cArrayell | v | Payload from the payment service provider. |
