...
| --- | --- | --- | --- |
| username | string | v | Customer's username. You define it when [creating a customer](https://documentation.spryker.com/docs/customers#create-a-customer). |
| password | password | v | Customer's password. You define it when [creating a customer](https://documentation.spryker.com/docs/customers#create-a-customer). |
