...
We highly recommend [installing and configuring the required software with WSL2](#https://documentation.spryker.com/docs/installing-docker-prerequisites-on-windows#installing-and-configuring-the-required-software-with-wsl2) since WSL1 is outdated, and you may get multiple issues with its configuration. Use it only if you can't use WSL2.
:::
