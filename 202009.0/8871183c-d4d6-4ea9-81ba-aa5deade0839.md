...
* [Silex Replacement Migration Concept](https://documentation.spryker.com/v4/docs/silex-replacement): Outlines the main changes to be applied in a project and concepts on how to migrate away from Silex to the Spryker Application replacing it.