...
Request sample: `GET http://glue.mysprykershop.com/customers`
...
```json
{
    ...
    "links": {
        "self": "http://glue.de.spryker.local/customers"
    }
}
```
</details>

See [Create a customer](#create-a-customer) to learn about the response attributes.
