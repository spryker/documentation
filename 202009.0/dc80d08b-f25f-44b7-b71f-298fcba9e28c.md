...
| --- | --- |
| ***{{customerReference}}*** | Unique identifier of the customer to get ifnormation for. This parameter is returned as the `id` attribute when [creating a customer](#create-a-customer). If your customer is already created, [retrieve customers](#retrieve-customers) to get it.  |
