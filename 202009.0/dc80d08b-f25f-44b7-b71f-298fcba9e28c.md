...
| --- | --- |
| ***{{customerReference}}*** | Unique identifier of the customer to get ifnormation for. This parameter is returned as the `id` attribute when [creating a customer](#create-a-customer). If you've already created a customer, [retrieve customers](#retrieve-customers) to get it.  |
