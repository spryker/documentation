...
3. Optional: install the [Xdebug browser extension](https://www.jetbrains.com/help/phpstorm/2021.1/browser-debugging-extensions.html). In the extension settins, for **IDE key**, enter `PHPSTORM`.
...
### Troubleshooting debugging configuration
...
2. Rerun or Refresh your application.
...
This section describes the required configuration for Xdebug in Visual Studio Code (VSCode).  

### VScode configuration prerequisites

Install the required software:

1. [Install VScode], the [Insiders version](https://code.visualstudio.com/insiders/) preferred.
2. [Install Xdebug](https://xdebug.org/docs/install). 
