    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/docs/barcode-generator" class="mr-link">Familiarize yourself with the Barcode Generator feature</a></li>
            </ul>
        </div>
        <!-- col2 -->
        <div class="mr-col">
            <ul class="mr-list mr-list-blue">
                ...
                <li><a href="https://documentation.spryker.com/docs/barcode-generator" class="mr-link">Familiarize yourself with the Barcode Generator feature</a></li>
                <li><a href="https://documentation.spryker.com/docs/product-barcodes" class="mr-link">View product barcode details</a></li>
            </ul>
        </div>
    </div>
</div>
