...
In Development mode, you can access your MySQL/MariaDB database using the credentials:
...
In case you're using the PostgreSQL database, you can use the following credentials:
