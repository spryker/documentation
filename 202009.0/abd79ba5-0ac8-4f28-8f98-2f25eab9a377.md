...
#### TableHelper
Allows to work with tables rendered on pages.

### Yves Helpers
Yves helpers can only be used for testing the Yves application.

#### FactoryHelper
Allows to mock and access the Factory.

#### DependencyProviderHelper
Allows to mock dependencies required for your tests.

## PropelSchemaHelper
Allows to create SimpleXMLElement based on XML schema file and format XML content.

## TableHelper
Allows to create a table in database and \Propel\Generator\Model\Table object based on a database engine.

## PropelFileHelper
Allows to create Propel model files based on builders and tables.
