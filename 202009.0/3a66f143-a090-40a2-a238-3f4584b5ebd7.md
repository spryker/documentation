:::(Error) ()
This Integration Guide refers to the upcoming product release and is subject to changes. If you want to install the most stable and tested version of this feature, refer to its Integration Guide from the current product release - [Spryker Core Feature Integration](https://documentation.spryker.com/docs/spryker-core-feature-integration-201907)
:::
...
```bash
composer require "spryker-shop/error-page": "^1.2.0",
composer require "spryker-shop/heartbeat-page": "^1.0.2",
composer require "spryker-shop/home-page": "^1.0.1",
composer require "spryker-shop/language-switcher-widget": "^1.1.0",
composer require "spryker-shop/navigation-widget": "^1.1.0",
composer require "spryker-shop/redirect-page": "^1.0.0",
composer require "spryker-shop/shop-application": "^1.6.0",
composer require "spryker-shop/shop-permission": "^1.2.0",
composer require "spryker-shop/shop-router": "^1.0.2",
composer require "spryker-shop/shop-translator": "^1.0.0",
composer require "spryker-shop/shop-ui": "^1.27.0",
composer require "spryker/application": "^3.18.0",
composer require "spryker/assertion": "^3.0.0",
composer require "spryker/country": "^3.3.0",
composer require "spryker/data-import": "^1.6.0",
composer require "spryker/event": "^2.7.0",
composer require "spryker/event-dispatcher": "^1.0.0",
composer require "spryker/glossary": "^3.7.0",
composer require "spryker/glossary-storage": "^1.4.0",
composer require "spryker/glue-application": "^1.21.0",
composer require "spryker/gui": "^3.24.0",
composer require "spryker/installer": "^4.0.1",
composer require "spryker/locale": "^3.2.0",
composer require "spryker/log": "^3.7.0",
composer require "spryker/maintenance": "^3.2.0",
composer require "spryker/permission": "^1.5.0",
composer require "spryker/propel": "^3.10.0",
composer require "spryker/propel-orm": "^1.9.0",
composer require "spryker/propel-query-builder": "^0.3.1",
composer require "spryker/rabbit-mq": "^2.7.0",
composer require "spryker/router": "^1.0.0",
composer require "spryker/scheduler": "^1.0.0",
composer require "spryker/session": "^4.4.0",
composer require "spryker/session-file": "^1.0.0",
composer require "spryker/session-redis": "^1.0.0",
composer require "spryker/setup": "^4.3.0",
composer require "spryker/setup-frontend": "^1.1.0",
composer require "spryker/storage": "^3.8.0",
composer require "spryker/storage-redis": "^1.0.0",
composer require "spryker/store": "^1.12.0",
composer require "spryker/store-gui": "^1.0.0",
composer require "spryker/synchronization": "^1.6.0",
composer require "spryker/synchronization-behavior": "^1.3.0",
composer require "spryker/translator": "^1.1.0",
composer require "spryker/url": "^3.5.0",
composer require "spryker/url-storage": "^1.5.0",
composer require "spryker/uuid-behavior": "^1.1.0",
composer require "spryker/vault": "^1.1.0",
composer require "spryker/zed-request": "^3.8.0"
```
...
### 3) Set up Behavior
1. Find the list of all the plugins installed along with new modules:
...
@(Warning)(Verification)(Visit `zed.mysprykershop.com` and make sure that Zed boots up without errors.)
...
### 3) Set up Publish and Synchronize
