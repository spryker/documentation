...
* To know how you create the product relation, see [Creating a Product Relation](https://documentation.spryker.com/v4/docs/creating-a-product-relation).
* To know the product relations are managed, see [Managing Product Relations](https://documentation.spryker.com/v4/docs/managing-product-relations).
* To know more about the attributes that you select and enter while creating or managing a product relation and see some examples of how the product relations look in the online store, see [Product Relations: Reference Information](https://documentation.spryker.com/v4/docs/product-relations-reference-information).