...
See [Managing search preferences](https://documentation.spryker.com/v4/docs/managing-search-preferences) for details on how you can manage the search preferences.
