    ...
    <div class="mr-list-container">
        ...
        <div class="mr-col">
            <ul class="mr-list mr-list-green">
                ...
                <li><a href="https://documentation.spryker.com/docs/en/back-office-feature-integration" class="mr-link">Integrate the Back Office Translations into your project</a></li>
            </ul>
        </div>
      <!-- col2 -->
        <div class="mr-col">
