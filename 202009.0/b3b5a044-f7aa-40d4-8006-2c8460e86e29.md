...
You can retrieve information about abstract and concerete products using dedicated endpoints.

### Retrieve Abstract Products
To retrieve information about an abstract product, send the request:

---
`GET` **/abstract-products/*{{sku}}***
...
| --- | --- |
| sku | SKU of an abstract product to get information for. |
...
| --- | --- | --- |
| include | Adds resource relationships to the request. | abstract-product-prices, concrete-products |
...
\*Type and ID attributes are not mentioned. For the attributes of included resources, see:
* [Prices](#prices-response-attributes)
* [Concrete Products](#concrete-products-response-attributes)

### Retrieve Concrete Products 
To retrieve information about a concrete product, send the request:
...
| Request  | Usage |
| --- | --- |
| `GET http://mysprykershop.com/concrete-products/001_25904006` | Get information about the `001_25904006` product.  |
| `GET http://mysprykershop.com/concrete-products/fish-1-1?include=sales-units,product-measurement-units` | Get information about the `fish-1-1` product with the information on its sales units and product mesurement units included. |

| String parameter | Description | Exemplary values |
| --- | --- | --- |
| include | Adds resource relationships to the request. | concrete-product-prices, product-measurement-units, sales-units |
| fields | 	Filters out the fields to be retrieved.  | name, image, description |
:::(Warning) (Performance)
* For performance and bandwidth usage optimization, we recommend filtering out only the needed information using the `fields` string parameter.

* If you include more resources, you can still use the `fields` string parameter to return only the needed fields. For example, `GET http://mysprykershop.com/concrete-products/fish-1-1?include=sales-units&fields[concrete-products]=name,description&fields[sales-units]=conversion,precision`.
...
*     [Prices](#prices-response-attributes)
*     [Sales Units](#sales-units-response-attributes)
...
---
`GET` **/concrete-products/*{{concrete-sku}}*/sales-units**
...
| Path parameter | Description |
| --- | --- |
| concrete-sku | SKU of a concrete product to get sales units for. |

### Request
Request sample: `GET http://mysprykershop.com/concrete-products/cable-vga-1-2/sales-units`
