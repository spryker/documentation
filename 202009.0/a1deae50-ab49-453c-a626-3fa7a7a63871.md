...
You can add multiple scheduled prices for the same abstract product. Repeat the process in [Add a scheduled price for an abstract product](#add-a-scheduled-price-for-an-abstract-product) until you add the desired number of scheduled prices. 
