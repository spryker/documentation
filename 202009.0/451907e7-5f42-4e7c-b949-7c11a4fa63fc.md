...
See [Products: Reference Information](https://documentation.spryker.com/docs/products-reference-information) to know more about abstract products and concrete products.
...
So first you create an abstract product. See [Creating an Abstract Product](https://documentation.spryker.com/docs/creating-an-abstract-product).