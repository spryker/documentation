This article contains content of the **product_group.csv** file to configure [Product Group](https://documentation.spryker.com/docs/product-gropus) information on your Spryker Demo Shop.
