...
<!---To create a frontend build in different ES5 and ES6 modes, use the list of commands from the [Console commands](https://spryker.atlassian.net/wiki/spaces/PS/pages/710410559/Console+commands){target="_blank"} table. See the YVES section.
-->
