...
The main purpose of the page-critical-path layout is to use the CSS lazy load only for the landing pages. To enable the CSS lazy load for your feature, see [Frontend CSS Lazy Load integration](https://documentation.spryker.com/docs/frontend-css-lazy-load).
