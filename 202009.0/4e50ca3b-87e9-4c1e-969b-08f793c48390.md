...
* `frontend/assets/DE/default`
 ...
 @(Info)(Info)(If the assets were generated earlier for this namespace and theme, these assets will be substituted by the newest ones. If namespace or theme were removed from the config file, assets for this namespace or theme won't be removed and you should remove it manually, if necessary.)
 
 ## How front-end builder collects SCSS and JS files
### Levels
...
@(Warning)(Note)(You can overwrite these files in your own namespace and/or theme.)
### SCSS
