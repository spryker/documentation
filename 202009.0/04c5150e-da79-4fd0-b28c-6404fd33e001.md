...
See [Implementing event trigger publisher plugins](https://documentation.spryker.com/docs/implementing-event-trigger-publisher-plugins) to learn how to create it.
