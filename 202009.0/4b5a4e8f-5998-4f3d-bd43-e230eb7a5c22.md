This endpoint allows to retrieve category nodes.
...
|---|---|
| ***node_id*** | ID of a node to get information for. [Retrieve a category tree](https://documentation.spryker.com/docs/retrieving-category-trees#retrieve-a-category-tree) to get full list of node IDs. |
