This endpoint allows retrieving navigation nodes.
...
|---|---|
| ***node_id*** | ID of a node to get information for. [Retrieve a category tree](https://documentation.spryker.com/docs/retrieving-navigation-trees#retrieve-a-navigation-tree) to get full list of node IDs. |
...
<a name="navigation-nodes-response-attributes"></a>
