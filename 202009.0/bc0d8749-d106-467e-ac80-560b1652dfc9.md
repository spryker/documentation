...
```bash
composer require spryker-feature/return-management:"dev-master" spryker/barcode:"^1.1.1" --update-with-dependencies
```
...
Run the following command(s) to install the required modules:
```bash
composer require spryker-feature/return-management:"dev-master" spryker-shop/barcode-widget:"^1.0.0" --update-with-dependencies
```
