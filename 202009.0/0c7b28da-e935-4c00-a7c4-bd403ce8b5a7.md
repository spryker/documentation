This endpoint allows to retrieve detailed information about abstract products.
...
To retrieve detailed information about an abstract product, send the request:
