...
| --- | --- | --- | --- |
| X-Agent-Authorization | string | v | A string containing digits, letters, symbols that authorized the agent assist. [Authenticate as an agent assist](https://documentation.spryker.com/docs/authenticating-as-an-agent-assist#authenticate-as-an-agent-assist) to get the value.  |
...
| --- | --- | --- | --- |
| customerReference | String | v | Defines the customer to impersonate. |
