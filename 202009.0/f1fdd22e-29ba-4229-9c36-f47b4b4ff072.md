...
#### Documentation
[Return Management](https://documentation.spryker.com/docs/en/return-management)
...
#### Documentation
[Custom Order Reference](https://documentation.spryker.com/docs/custom-order-reference)
...
#### Documentation
[Filter and Search in Order Archive](https://documentation.spryker.com/docs/shop-guide-order-history#sorting-and-filtering-orders--b2b-shop-)
...
#### Documentation
[Quotation Process & RFQ](https://documentation.spryker.com/docs/quotation-process-rfq-201907)
...
#### Documentation
[Product Group](https://documentation.spryker.com/docs/product-group)
...
#### Documentation
[Navigation](https://documentation.spryker.com/docs/navigation-feature-summary) 
...
#### Documentation
[Quick Order from the Catalog Page](https://documentation.spryker.com/docs/quick-order-from-the-catalog-page)
...
#### Documentation
[Customer Registration](https://documentation.spryker.com/docs/customer-registration)
...
#### Documentation
[HowTo - Display Custom Names for Order Item States on the Storefront](https://documentation.spryker.com/docs/howto-display-custom-names-for-order-item-states-on-the-storefront)
...
#### Documentation
[Order Cancellation](https://documentation.spryker.com/docs/order-cancellation)
...
#### Documentation
[Invoice Generation](https://documentation.spryker.com/docs/en/invoice-generation)
...
#### Documentation
[About Demo Shop Data Import](https://documentation.spryker.com/docs/about-demo-shop-data-import)
...
#### Documentation
[Importing Data with a Configuration File](https://documentation.spryker.com/docs/importing-data-with-configuration-file)
...
#### Documentation
[Importing Product Data With a Single File](https://documentation.spryker.com/docs/en/importing-product-data-with-a-single-file)
...
#### Documentation
[Data Export](https://documentation.spryker.com/docs/data-export)
...
#### Documentation
[Measurement Units API](https://documentation.spryker.com/docs/retrieving-measurement-units)
...
#### Documentation
[Shopping Lists API](https://documentation.spryker.com/docs/managing-carts-of-registered-users)
...
#### Documentation
[Promotions API](https://documentation.spryker.com/docs/retrieving-promotional-items)
...
#### Documentation
[Token Revocation](https://documentation.spryker.com/docs/authentication-and-authorization#token-revocation)
...
* [Managing Gift Cards of Guest Users](https://documentation.spryker.com/docs/en/managing-gift-cards-of-guest-users)
* [Managing Gift Cards of Registered Users](https://documentation.spryker.com/docs/en/managing-gift-cards-of-registered-users)
...
#### Documentation
[Resource Relationships](https://documentation.spryker.com/docs/documenting-glue-api-resources#resource-relationships)
...
#### Documentation
[CLI Entry Point for Yves](https://documentation.spryker.com/docs/cli-entry-point-for-yves)
...
#### Documentation
[OMS Timeout Processor](https://documentation.spryker.com/docs/order-process-modelling-state-machines#oms-timeout-processor)
