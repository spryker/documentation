...
1. Upgrade the **ContentBanner** module to version 2.0.0. See [Migration Guide - ContentBanner](https://documentation.spryker.com/v3/docs/mg-contentbanner-201907) for  details on how to upgrade.
