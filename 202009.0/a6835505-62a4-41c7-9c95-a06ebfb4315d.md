...
Spryker offers support for using **MySQL**/**MariaDB** or **PostgreSQL** as database servers. By default, the virtual machine is configured to use the MariaDB database server, but you can easily change it so that it uses the **PostgreSQL** database server.
...
| :-------------: | :-----------------: | :---------: |
|      MySQL/MariaDB      | ZED_DB_ENGINE_MYSQL |    3306     |
