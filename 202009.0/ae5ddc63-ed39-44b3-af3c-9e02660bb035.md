...
For information about installing the Spryker Commerce OS see [Getting Started Guide](https://documentation.spryker.com/v3/docs/dev-getting-started).
...
* [Security and Authentication](https://documentation.spryker.com/v3/docs/security-and-authentication)
...
**Documentation**: [Payone - Cash on Delivery](https://documentation.spryker.com/v3/docs/payone-cash-on-delivery)
...
**Documentation**: [Heidelpay - Easy Credit](https://documentation.spryker.com/v3/docs/heidelpay-easy-credit)
...
* [RatePay - Prepayment](https://documentation.spryker.com/v3/docs/ratepay-prepayment)
* [RatePay - Invoice](https://documentation.spryker.com/v3/docs/ratepay-invoice)
* [RatePay - Direct Debit](https://documentation.spryker.com/v3/docs/ratepay-direct-debit)
* [RatePay - Installment](https://documentation.spryker.com/v3/docs/ratepay-installment)
...
**Documentation**: [Episerver](https://documentation.spryker.com/v3/docs/episerver) 
...
**Documentation**: [Ratenkauf by Easycredit - Installation and Configuration](https://documentation.spryker.com/v3/docs/ratenkauf-by-easycredit-installation-and-configuration)
...
**Documentation**: [CrefoPay](https://documentation.spryker.com/v3/docs/crefopay-configuration) 
...
 
Check out [Documentation Updates](https://documentation.spryker.com/v3/docs/documentation-updates) for all the updates to documentation made with this release. 