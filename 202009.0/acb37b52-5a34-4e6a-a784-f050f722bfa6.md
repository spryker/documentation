@(Info)()(This tutorial provides step-by-step instruction for the process of building your own product relation type.)
...
@(Info)(For example:)(`TYPE_RELATION_NEW`)
...
@(Warning)()(You can use `RelatedProductsDataProvider` or `UpSellingDataProvider` as sample implementations.)