...
| --- | --- | --- | --- |
| Authorization | string | Only required when revoking all the refresh token of a company user.  | A string containing digits, letters, and symbols that authorize the company user. [Authenticate as a company user](https://documentation.spryker.com/docs/authenticating-as-a-company-user#authenticate-as-a-company-user) to get the value.  |
