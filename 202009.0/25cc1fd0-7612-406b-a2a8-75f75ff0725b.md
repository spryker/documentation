...
This guide only describes the Product Concrete Search and [Add to cart from the Catalog page](https://documentation.spryker.com/v4/docs/quick-order-from-the-catalog-page) integration.
:::
