This article contains content of the **navigation_node.csv** file to configure [Navigation Node](https://documentation.spryker.com/docs/navigation-node-types) information on your Spryker Demo Shop.
