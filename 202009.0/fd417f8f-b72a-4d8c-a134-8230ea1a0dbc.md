...
1. Using your terminal navigate to your project root folder, there you can find src/ directory and composer.json file.
...
3. Checkout the local clone of the repository to a specific hash, branch, or tag:
```bash
cd docker
