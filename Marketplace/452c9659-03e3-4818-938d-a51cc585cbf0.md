...
| --- | --- | --- |
| include | Adds resource relationships to the request. | concrete-product-image-sets, concrete-product-availabilities, product-options, product-reviews, product-offers, concrete-product-prices, product-measurement-units, sales-units, product-labels, product-offers | 
...
| `GET https://glue.mysprykershop.com/concrete-products/001_25904006?include=product-offers` | Retrieve information for a concrete product with SKU `001_25904006` with product offers included. |
