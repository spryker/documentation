...
| merchant_name | Filters the results by Merchant name.  | {{name_of_the_merchant}} **This option is available only if you have upgraded your shop to Marketplace.**|

| Request   | Usage     |
| --------------- | -------------- |
| `GET https://glue.mysprykershop.com/catalog-search?q=`       | Search for all available products.   |
| `GET https://glue.mysprykershop.com/catalog-search?q=058&include=abstract-products` | Search for an abstract product by SKU with the included product details. |
| `GET https://glue.mysprykershop.com/catalog-search?q=Acer Liquid Jade` | Search for an abstract product by name.    |
| `GET https://glue.mysprykershop.com/catalog-search?q=058_261755504` | Search for a concrete product by SKU.  |
| `GET https://glue.mysprykershop.com/catalog-search?q=sony+red` | Search for products by multiple attributes (brand and color in our example). |
| `GET https://glue.mysprykershop.com/catalog-search?q=sony&price%5Bmin%5D=99.99&price%5Bmax%5D=150` | Search for products within a minimum and maximum price range. |
| `GET https://glue.mysprykershop.com/catalog-search?q=sony`   | Search for products of a specific brand.   |
| `GET https://glue.mysprykershop.com/catalog-search?label[]=NEW&label[]=SALE %` | Search for products with specific labels.  |
| `GET https://glue.mysprykershop.com/catalog-search?weight[]=45 g` | Search for products by weight.  |
| `GET https://glue.mysprykershop.com/catalog-search?color[]=Blue` | Search for products by color.   |
| `GET https://glue.mysprykershop.com/catalog-search?storage_capacity[]=32 GB` | Search for products by storage capacity. |
| `GET https://glue.mysprykershop.com/catalog-search?rating[min]=4` | Search for products by rating.     |
| `GET https://glue.mysprykershop.com/catalog-search?category=6` | Search for products by a category node ID.    |
| `GET https://glue.mysprykershop.com/catalog-search?currency=CHF` | Define currency for the search result products.   |
...
| `GET https://glue.mysprykershop.com/catalog-search?merchant_name=Spryker` | Filter the results by Merchant name. **This option is available only if you have upgraded your shop to the Marketplace provided by Spryker.** |
...
This option is available only if you have upgraded your shop to Marketplace provided by Spryker.
...
| 503      | Invalid type (non-integer) of one of the request parameters:<ul><li>rating<li><li>minrating<li><li>maxpage<li><li>limitpage<li><li>offsetcategory<li></ul> |
