...
| productOfferReference | String |✓|Unique identifier of the Product Offer in the system. **This option is available only in case you have upgraded your shop to Marketplace provided by Spryker.** |
...
| guest-cart-items |productOfferReference | String | Unique identifier of the Product Offer in the system. **This option is available only in case you have upgraded your shop to Marketplace provided by Spryker.** |
| guest-cart-items | merchantReference | String | Unique identifier of the Merchant in the system. **This option is available only in case you have upgraded your shop to Marketplace provided by Spryker.** |
