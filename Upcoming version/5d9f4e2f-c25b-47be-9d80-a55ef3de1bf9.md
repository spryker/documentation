...
See [Adding Content Item Widgets to Pages and Blocks](https://documentation.spryker.com/docs/adding-content-item-widgets-to-pages-and-blocks) to learn more about working with content item widgets in the WYSIWYG editor.
