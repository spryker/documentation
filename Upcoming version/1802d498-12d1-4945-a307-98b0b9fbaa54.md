...
1. Update `spryker/quote-request-agent` to version ^2.0.0 by following the steps from [Migration Guide - QuoteRequestAgent](https://documentation.spryker.com/v4/docs/mg-quoterequestagent).
