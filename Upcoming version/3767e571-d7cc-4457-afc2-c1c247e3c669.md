Spryker Frontend consists of two main parts: [Atomic Frontend](https://documentation.spryker.com/v4/docs/atomic-frontend) (JS/CSS/Twg) and [Modular Frontend](https://documentation.spryker.com/v4/docs/modular-frontend) (Widgets and Pages). Both support theming and the same inheritance strategy: Current Theme > Default Theme.
