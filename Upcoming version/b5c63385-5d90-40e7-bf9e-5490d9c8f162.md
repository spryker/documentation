The [list of console commands](https://documentation.spryker.com/docs/getting-the-list-of-console-commands-and-available-options) contains the command names together with a short description of what the command does. The most important commands in Spryker can be split into 4 categories : collector commands, order management system commandsб setup commands, and frontend-related commands. This article provides details on each of the commands.
