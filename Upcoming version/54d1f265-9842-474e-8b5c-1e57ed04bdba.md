...
In fact, any Administration Interface user can be an Agent. All you need to do for that is select the *This user is an Agent* checkbox on the *User create/edit page*, and the user gets the Agent mark. See [Adding New Users](https://documentation.spryker.com/v3/docs/managing-users) to learn more about how to create a new Agent user in the Back Office.
