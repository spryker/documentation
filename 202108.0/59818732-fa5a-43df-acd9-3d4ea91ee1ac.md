...
| --- | --- |
| ***{{guest_cart_uuid}}*** | Unique identifier of the guest cart to redeem the gift card in. To get it, [create](https://documentation.spryker.com/docs/managing-guest-carts#create-a-guest-cart) or [retrieve a guest cart](https://documentation.spryker.com/docs/managing-guest-carts#retrieveaguestcart). |
