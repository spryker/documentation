...
## Tips**
"Approve Access" and "Deny Access" are parts of the Merchant functionality. It allows/denies access to Merchant portal. If project doesn not have Merchant Portal - "Approve Access" and "Deny Access" will do nothing. 
