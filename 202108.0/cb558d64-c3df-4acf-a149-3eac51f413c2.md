...
5. In the *Price & Tax* tab, set prices and taxes for products:
    ...
    4. **B2B only:** In **Merchant Price Dimension**, select the merchant relationship to define a special price per merchant relation. See [Merchants](https://documentation.spryker.com/v4/docs/merchants) for more information.
