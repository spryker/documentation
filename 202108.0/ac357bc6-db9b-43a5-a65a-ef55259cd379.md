...
:::(Info) (Note)
Alternatively, you can retrieve all carts belonging to a customer through the **/customers/*{{customerId}}*/carts** endpoint. For details, see [Retrieving customer carts](https://documentation.spryker.com/2021080/docs/retrieving-customer-carts).
:::
