...
@(Info)()(To find out more information about the attributes that you see on the *Edit Discount* page, in the Creating a voucher guides, see the [Reference information: Creating a voucher](https://documentation.spryker.com/docs/creating-a-voucher#reference-information--creating-a-voucher) section.
