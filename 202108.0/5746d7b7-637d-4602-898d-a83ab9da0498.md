...
3. In the *General* tab, do the following:
    ...
    * Select a page template that will determine a page layout. This is a *mandatory* step.
    @(Info)()(Templates are project-specific and are usually created by a developer and business person. If you are missing a CMS page template, contact them and refer to the [HowTo - Create CMS templates](https://documentation.spryker.com/2021080/docs/ht-create-cms-templates#cms-page-template).)
