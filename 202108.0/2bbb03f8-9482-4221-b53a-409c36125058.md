...
For information about installing the Spryker Commerce OS, see [Getting Started Guide](https://documentation.spryker.com/v2/docs/dev-getting-started).
...
**Documentation**: [Discount](https://documentation.spryker.com/v2/docs/discount). 
...
**Documentation**: [Assigning a Template for a Category Page](https://documentation.spryker.com/v2/docs/category)
...
**Documentation**: [Session Management](https://documentation.spryker.com/v2/docs/session-handlers).
...
**Documentation**: [Code Sniffer](https://documentation.spryker.com/v2/docs/code-sniffer), [Architecture Sniffer](https://documentation.spryker.com/v2/docs/architecture-sniffer), [PHPStan](https://documentation.spryker.com/v2/docs/phpstan-201903).
...
**Documentation**: [Heidelpay - Split-payment Marketplace](https://documentation.spryker.com/v2/docs/heidelpay-split-payment-marketplace).
...
**Documentation**: [Adyen](https://documentation.spryker.com/v2/docs/adyen).
...
**Documentation**: [AfterPay](https://documentation.spryker.com/v2/docs/afterpay).

Check out [Documentation Updates](https://documentation.spryker.com/v2/docs/documentation-updates) for all the updates to documentation made with this release. 