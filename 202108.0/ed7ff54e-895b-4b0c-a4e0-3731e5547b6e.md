...
For information about installing the Spryker Commerce OS, see [Getting Started Guide](https://documentation.spryker.com/v1/docs/dev-getting-started).
...
**Documentation**: [Catalog Search](https://documentation.spryker.com/v1/docs/catalog-search).
...
**Documentation**: [Managing Customers](https://documentation.spryker.com/v1/docs/managing-customers).
...
**Documentation**: [Managing Carts](https://documentation.spryker.com/v1/docs/managing-carts).
...
**Documentation**: [Checking Out Purchases and Getting Checkout Data](https://documentation.spryker.com/v1/docs/checking-out-purchases-and-getting-checkout-data).
...
**Documentation**: [Managing Customers](https://documentation.spryker.com/v1/docs/managing-customers), [Managing Wishlists](https://documentation.spryker.com/v1/docs/managing-wishlists), [Retrieving Customer's Order History](https://documentation.spryker.com/v1/docs/retrieving-order-history).
...
**Documentation**: [REST API Reference](https://documentation.spryker.com/v1/docs/rest-api-reference).
