...
2. Send the request: `GET http://glue.mysprykershop.com/customers/{{customer_id}}?include=addresses`.
...
1. Send the request: `DELETE http://glue.mysprykershop.com/refresh-tokens/{{refresh_token}`[.](#)
