...
Make sure that:
*   You have all the security updates from Spryker modules.
*   You have all the security updates from other modules.
...
### Demo data
Make sure that:
*   Demo admin users are removed.
*   New admin users are created with strong passwords.
